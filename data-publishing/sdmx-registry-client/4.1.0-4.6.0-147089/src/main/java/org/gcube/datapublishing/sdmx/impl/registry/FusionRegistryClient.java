...
public class FusionRegistryClient implements SDMXRegistryClient {
	...
	private VersionResult versionOk (String beanVersion, String agencyId, String id, String typeCode) throws SDMXRegistryClientException
	{
		...
		if (this.checkVersion)
		{
			...
			{
				log.debug("Unable to get data on the server, setting version to 0",e);
	...
	public static void main(String[] args) {
		System.out.println(SDMX_STRUCTURE_TYPE.CODE_LIST.getUrnClass());
	}
...
//		SDMXRegistryClient registryClient = new FusionRegistryClient(descriptor);
//		SdmxBeans beans = registryClient.getCodelist("ENG", "NEW_CL_DIVISION", "", Detail.referencestubs, References.none);
//		
//		Set<CodelistBean> cls = beans.getCodelists();
//		System.out.println(cls.size());
//		System.out.println(cls.iterator().next().getVersion());
//	}
