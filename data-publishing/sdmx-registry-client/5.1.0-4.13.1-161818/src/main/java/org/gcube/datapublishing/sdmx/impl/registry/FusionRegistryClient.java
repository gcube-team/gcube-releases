...
public class FusionRegistryClient implements SDMXRegistryClient {
	...
	public SubmissionReport publish(AgencySchemeBean agencyScheme)
		...
		return publishMaintanableArtefact(agencyScheme,this.checkVersion);
	...
	public SubmissionReport publish(CodelistBean codelist)
			throws SDMXRegistryClientException {
		return publishMaintanableArtefact(codelist,this.checkVersion);
	}
	@Override
	public SubmissionReport publish(ConceptSchemeBean conceptscheme)
			throws SDMXRegistryClientException {
		return publishMaintanableArtefact(conceptscheme,this.checkVersion);
	}
	@Override
	public SubmissionReport publish(DataStructureBean datastructure)
			throws SDMXRegistryClientException {
		return publishMaintanableArtefact(datastructure,this.checkVersion);
	}
	@Override
	public SubmissionReport publish(DataflowBean dataflow)
			throws SDMXRegistryClientException {
		return publishMaintanableArtefact(dataflow,this.checkVersion);
	}
	@Override
	public SubmissionReport publish(DataProviderSchemeBean dataproviderscheme)
			throws SDMXRegistryClientException {
		return publishMaintanableArtefact(dataproviderscheme,this.checkVersion);
	}
	@Override
	public SubmissionReport publish(ProvisionAgreementBean provisionagreement)
			throws SDMXRegistryClientException {
		return publishMaintanableArtefact(provisionagreement,this.checkVersion);
	}
	...
	private SubmissionReport publishMaintanableArtefact(MaintainableBean bean, boolean checkVersion)
			throws SDMXRegistryClientException {

		VersionResult versionResult = versionOk(bean.getVersion(), bean.getAgencyId(), bean.getId(), bean.getStructureType().getUrnClass(),checkVersion);
