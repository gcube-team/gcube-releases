...
public class HTTPCall {
	...
	public <C> C call(Class<C> clz, String path, HTTPMETHOD method, Map<String, String> parameters) throws Exception {
	...
	protected <C> C call(Class<C> clz, String path, HTTPMETHOD method, Map<String, String> parameters, String body) throws Exception {
