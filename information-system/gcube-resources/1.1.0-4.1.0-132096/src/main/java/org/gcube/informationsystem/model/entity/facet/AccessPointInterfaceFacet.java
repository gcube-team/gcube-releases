...
import org.gcube.informationsystem.impl.entity.facet.AccessPointInterfaceFacetImpl;
 ...
 */
@Key(fields={AccessPointInterfaceFacet.ENDPOINT_PROPERTY})
@JsonDeserialize(as=AccessPointInterfaceFacetImpl.class)
public interface AccessPointInterfaceFacet extends Facet {
	
	public static final String NAME = "AccessPointInterfaceFacet"; //AccessPointInterfaceFacet.class.getSimpleName();
