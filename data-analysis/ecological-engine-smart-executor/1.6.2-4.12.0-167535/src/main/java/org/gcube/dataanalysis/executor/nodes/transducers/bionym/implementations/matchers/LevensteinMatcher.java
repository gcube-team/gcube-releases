...
public class LevensteinMatcher extends YasmeenMatcher {

	public LevensteinMatcher(String sandboxfolder, double threshold, int maxResults,HashMap<String, String> parameters) {
