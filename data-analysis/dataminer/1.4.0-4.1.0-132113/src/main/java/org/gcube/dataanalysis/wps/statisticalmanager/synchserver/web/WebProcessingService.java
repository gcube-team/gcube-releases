...
import org.n52.wps.server.database.AbstractDatabase;
...
public class WebProcessingService extends HttpServlet {
    ...
    protected void setServerParameters(){
		...
		System.out.println("Setting server parameters: Host: " + host + " Port: " + port + " Webapp: " + webapp + " ");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("Set Encoding to "+characterEncoding);
            int contentLength = req.getContentLength();
            if (contentLength > MAXIMUM_REQUEST_SIZE) {
            	System.out.println("POST request rejected, request size of " + contentLength + " too large.");
            ...
            System.out.println("Received POST: Content-Type = " + contentType + ", Character-Encoding = " + characterEncoding
                    + ", Content-Length = " + contentLength);
            ...
            System.out.println("POST request contained  " + requestSize + " characters");
            ...
            if (requestSize >= MAXIMUM_REQUEST_SIZE && reader.read() > -1) {
                ...
                System.out.println("POST request rejected, request size of " + requestSize + " too large.");
                ExceptionReport er = new ExceptionReport("Request body too large, limited to " + MAXIMUM_REQUEST_SIZE
                        + " bytes", ExceptionReport.NO_APPLICABLE_CODE);
                handleException(er, res);
            }
            ...
            System.out.println("Incoming document is " + documentString);
            ...
            System.out.println("Flushing request");
        }
    }
