...
public class SDMXCodelistExporter extends ResourceCreatorWorker {
	...
	protected ResourcesResult execute() throws WorkerException {
		try {
			...
			SDMXResource sdmxResource = new SDMXResource(new URL(WorkerUtils.getResourceURI(this.targetUrl)), this.targetId, this.targetVersion, this.targetAgency,  SDMXResource.TYPE.CODE_LIST);
