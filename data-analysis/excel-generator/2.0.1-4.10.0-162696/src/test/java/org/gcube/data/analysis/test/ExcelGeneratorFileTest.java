...
public class ExcelGeneratorFileTest extends ExcelGenerator{
	...
	public ExcelGeneratorFileTest(DataTable table, String filePath) {
		super(table);
	...
	public static void main(String[] args) {
		DataTableImpl table = new DataTableImpl("testTable");
		...
		table.addColumn(new StringColumn("id", new GenericFormat("idFormat", "numeric"),new ArrayList<>(Arrays.asList("1","2","3")),ColumnType.DIMENSION));
		...
		table.addColumn(new StringColumn("codeColumn", new CodelistDataFormat("codelistColumn",Arrays.asList("id2","id1","id2"),Arrays.asList("value1","value2","value3")),ColumnType.DIMENSION));	
