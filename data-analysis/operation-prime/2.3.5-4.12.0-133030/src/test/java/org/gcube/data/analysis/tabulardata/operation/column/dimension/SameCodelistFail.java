...
public class SameCodelistFail extends OperationTester {
	...
	public void init(){
		...
		targetTable=datasetHelper.createSampleDataset(codelistTable);
	}
	...
	protected ColumnLocalId getTargetColumnId() {
		return targetTable.getColumnsByType(AttributeColumnType.class).get(0).getLocalId();
	}
