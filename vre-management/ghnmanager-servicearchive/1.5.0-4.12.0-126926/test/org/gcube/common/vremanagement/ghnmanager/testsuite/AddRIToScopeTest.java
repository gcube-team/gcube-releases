...
/**
 * Tester for <em>addRIToScope</em> operation (GHNManager)
 * 
 * @author Manuele Simi
 *
 */
public class AddRIToScopeTest {

	public static void main(String[] args) {
		
		if (args.length < 6)
			AddRIToScopeTest.printUsage();		
	...
	private static void printUsage() {
		...
		System.out.println("\tAddRIToScopeTest <GHN host> <GHN port> <caller scope> <RI ServiceClass> <RI ServiceName> <new scope>");
		System.out.println("");
		System.exit(0);
