...
/**
 * Parameter of type {@link gr.uoa.di.madgik.commons.configuration.parameter.IParameter.ParameterType#IntegerPrimitive}.
 * An example of this instnace configuratino type is the following
 * <p>
 * <pre>
 * {@code
 *
 * <param name="parameterKey" type="IntegerPrimitive" generated="false" internal="false">4</param>
 *
 * }
 * </pre>
 * </p>
 ...
 * @author gpapanikos
 */
public class IntegerPrimitiveParameter implements IParameter
{
	...
	{
		return ParameterType.IntegerPrimitive;
	}
	...
	public void FromXML(Element element) throws Exception
	{
		...
		if (!this.generated)
		{
			this.Value = Integer.parseInt(XMLUtils.GetChildText(element));
		}
	}
}
