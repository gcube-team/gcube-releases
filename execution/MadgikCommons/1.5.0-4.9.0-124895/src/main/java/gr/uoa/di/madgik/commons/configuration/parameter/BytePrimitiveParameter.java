...
/**
 * Prameter of type {@link gr.uoa.di.madgik.commons.configuration.parameter.IParameter.ParameterType#BytePrimitive}.
 ...
 * @author gpapanikos
 */
public class BytePrimitiveParameter implements IParameter
{
	...
	{
		return ParameterType.BytePrimitive;
	}
