...
/**
 * Parameter of type {@link gr.uoa.di.madgik.commons.configuration.parameter.IParameter.ParameterType#FloatPrimitive}.
 * An example of this instnace configuratino type is the following
 * <p>
 * <pre>
 * {@code
 *
 * <param name="parameterKey" type="FloatPrimitive" generated="false" internal="false">4.5</param>
 *
 * }
 * </pre>
 * </p>
 ...
 * @author gpapanikos
 */
public class FloatPrimitiveParameter implements IParameter
{
	...
	{
		return ParameterType.FloatPrimitive;
	}
	...
	public void FromXML(Element element) throws Exception
	{
		...
		if (!this.generated)
		{
			this.Value = Float.parseFloat(XMLUtils.GetChildText(element));
		}
	}
}
