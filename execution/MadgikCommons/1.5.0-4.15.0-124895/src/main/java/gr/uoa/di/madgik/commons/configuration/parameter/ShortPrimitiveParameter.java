...
/**
 * Parameter of type {@link gr.uoa.di.madgik.commons.configuration.parameter.IParameter.ParameterType#ShortPrimitive}.
 * An example of this instnace configuratino type is the following
 * <p>
 * <pre>
 * {@code
 *
 * <param name="parameterKey" type="ShortPrimitive" generated="false" internal="false">4</param>
 *
 * }
 * </pre>
 * </p>
 ...
 * @author gpapanikos
 */
public class ShortPrimitiveParameter implements IParameter
{
	...
	{
		return ParameterType.ShortPrimitive;
	}
	...
	public void FromXML(Element element) throws Exception
	{
		...
		if (!this.generated)
		{
			this.Value = Short.parseShort(XMLUtils.GetChildText(element));
		}
	}
}
