...
/**
 * Parameter of type {@link gr.uoa.di.madgik.commons.configuration.parameter.IParameter.ParameterType#XML}.
 * An example of this instnace configuratino type is the following
 * <p>
 * <pre>
 * {@code
 *
 * <param name="parameterKey" type="XML" generated="false" internal="false">&lt;root&gt;&lt;a&gt;foo&lt;/a&gt;&lt;b&gt;bar&lt;/b&gt;&lt;/root&gt;></param>
 *
 * }
 * </pre>
 * </p>
 ...
 * @author gpapanikos
 */
public class XMLParameter implements IParameter
{
	...
	public void FromXML(Element element) throws Exception
	{
		...
		if (!this.generated)
		{
			this.Value = XMLUtils.UndoReplaceSpecialCharachters(XMLUtils.GetChildText(element));
		}
	}
}
