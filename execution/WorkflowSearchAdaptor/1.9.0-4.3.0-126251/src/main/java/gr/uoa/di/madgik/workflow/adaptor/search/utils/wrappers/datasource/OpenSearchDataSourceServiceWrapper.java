 ...
 *
 */
public abstract class OpenSearchDataSourceServiceWrapper extends DataSourceWrapper 
{
	...
	public OpenSearchDataSourceServiceWrapper(String serviceEndpoint, EnvHintCollection hints) throws ExecutionValidationException 
	{
		logger.info("serviceEndpoint : " + serviceEndpoint);
		this.type = Type.OpenSearchDataSource;
