...
import gr.uoa.di.madgik.workflow.adaptor.search.utils.LocatorElevationFilter;
...
public abstract class ProcessingWrapper extends FunctionalityWrapper 
{
	...
	{
		if(elevationElement == null) return new IPlanElement[]{};
		else return new IPlanElement[]{elevationElement};
	}
