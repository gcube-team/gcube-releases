...
import gr.uoa.di.madgik.workflow.adaptor.search.utils.wrappers.datasource.SruConsumerServiceWrapper;

public class GCubeSruConsumerServiceWrapper extends SruConsumerServiceWrapper
{
	private static final long serialVersionUID = 1L;
	
	public GCubeSruConsumerServiceWrapper(String serviceEndpoint, EnvHintCollection hints) throws ExecutionValidationException 
	{
...
//		instantiateQueryEnvelopInput.TokenProvidingVariableNames.add(variableNames.get(Variables.Action));
	...
	{
		return "http://gcube-system.org/namespaces/search/SruConsumer";
	}
	...
	{
		return serviceEndpoint + "/SruConsumerPortType/query";
	}
