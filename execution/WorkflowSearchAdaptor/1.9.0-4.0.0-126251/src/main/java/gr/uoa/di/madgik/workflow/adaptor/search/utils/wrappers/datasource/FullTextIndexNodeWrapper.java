...
//	public static final String ServiceClass = "Index";
//	public static final String ServiceName = "FullTextIndexLookup";
//	public static final String ServiceNamespace = "http://gcube-system.org/namespaces/indexmanagement/FullTextIndexLookupService";
//	private static final String OutputLocatorExtractionExpression = "*[local-name()='Envelope' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']" + 
//	"/*[local-name()='Body' and namespace-uri()='http://schemas.xmlsoap.org/soap/envelope/']" + 
//	"/*[local-name()='queryResponse' and namespace-uri()='" + FullTextIndexLookupWrapper.ServiceNamespace + "']" + 
//	"/text()";
	...
	public FullTextIndexNodeWrapper(String serviceEndpoint, EnvHintCollection hints) throws ExecutionValidationException 
	{
		logger.info("serviceEndpoint : " + serviceEndpoint);
//		serviceEndpoint += "/query";
		this.type = Type.FullTextIndexNode;
	...
	private void preconstructVariables(String serviceEndpoint, EnvHintCollection hints) throws ExecutionValidationException 
	{
		...
		variables.put(Variables.Sids, DataTypeUtils.GetNamedDataType(true, variableNames.get(Variables.Sids), variableNames.get(Variables.Sids), DataTypes.String, "sids_placeholder"));
...
//		extractRSLocatorFilter.OutputQueryResultType = OutputResultType.String;
		...
		WSRESTArgument sidsArg=new WSRESTArgument();
		sidsArg.Order=1;
		sidsArg.ArgumentName="sids";
		sidsArg.Parameter=(IInputParameter) ParameterUtils.GetSimpleParameter(ParameterDirectionType.In, variableNames.get(Variables.Sids));
		
		
		queryCall.ArgumentList.add(sidsArg);
	...
	protected abstract void extendAddVariablesToPlan(ExecutionPlan plan) throws Exception;
	...
	public void addVariablesToPlan(ExecutionPlan plan) throws Exception 
	{
		...
		plan.Variables.Add(variables.get(Variables.Sids));
