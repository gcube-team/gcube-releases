...
public abstract class TestAdaptorBase
{
	...
	protected static String GetStringFilePayload(String path) throws IOException
	{
	...
	protected static byte[] GetByteFilePayload(String path) throws IOException
	{
	...
	protected static String GetWorkflowEngineEndpoint(String Scope) throws Exception
	{
		...
		String endpoint = eps.get(randGen.nextInt(eps.size()));
	...
	protected static WorkflowEngineServicePortType GetWorkflowEnginePortType(String Scope, String endpoint) throws Exception
	{
		...
		wf = GCUBERemotePortTypeContext.getProxy(wf, GCUBEScope.getScope(Scope),TestAdaptorBase.DefaultInvocationTimeout);
		return wf;
	}
	...
	{
		AccessInfo url1 = TestAdaptorBase.ParseUrlAccessInfo("ftp://user:pass@donald.di.uoa.gr");
		String url2 = TestAdaptorBase.StripUrlPort("ftp://donald.di.uoa.gr");
		String url3 = TestAdaptorBase.StripUrlPort("ftp://donald.di.uoa.gr:34");
		String url4 = TestAdaptorBase.StripUrlPort("ftp://user:pass@donald.di.uoa.gr:34");
		String url5 = TestAdaptorBase.StripUrlPort("ftp://user:pass@donald.di.uoa.gr");
