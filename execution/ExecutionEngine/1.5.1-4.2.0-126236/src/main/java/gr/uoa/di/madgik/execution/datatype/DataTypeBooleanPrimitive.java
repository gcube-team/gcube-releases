 ...
 */
public class DataTypeBooleanPrimitive implements IDataType
{
	...
	/**
	 * Returns {@link IDataType.DataTypes#BooleanPrimitive}
	 * 
	...
	/**
	 * Sets the provided payload using {@link DataTypeUtils#GetValueAsBoolean(Object)}
	...
	public void SetValue(Object Value) throws ExecutionValidationException
	{
		...
		else this.Value= DataTypeUtils.GetValueAsBoolean(Value);
	}
