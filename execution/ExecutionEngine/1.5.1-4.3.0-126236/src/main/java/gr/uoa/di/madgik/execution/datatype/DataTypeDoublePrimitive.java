 ...
 */
public class DataTypeDoublePrimitive implements IDataType
{
	...
	/**
	 * Returns {@link IDataType.DataTypes#DoublePrimitive}
	 * 
	...
	/**
	 * Sets the provided payload using {@link DataTypeUtils#GetValueAsDouble(Object)}
	...
	public void SetValue(Object Value) throws ExecutionValidationException
	{
		...
		else this.Value=DataTypeUtils.GetValueAsDouble(Value);
	}
