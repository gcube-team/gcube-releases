 ...
 * @author gpapanikos
 */
public class ExecutionStartedStateEvent extends ExecutionStateEvent
{
	...
	/**
	 * Instantiates a new execution started state event.
	 */
	public ExecutionStartedStateEvent()
	{
	...
	{
		return ExecutionStateEvent.EventName.ExecutionStarted;
	}
