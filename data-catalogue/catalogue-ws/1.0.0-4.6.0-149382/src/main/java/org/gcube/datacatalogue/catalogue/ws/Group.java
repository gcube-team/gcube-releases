...
public class Group {
	...
	public String show(@Context UriInfo uriInfo){
		...
		return CatalogueUtils.delegateGet(caller, context, Constants.GROUP_SHOW, uriInfo);
	...
	public String organizationList(@Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegateGet(caller, context, Constants.GROUP_LIST, uriInfo);
	...
	public String create(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.GROUP_CREATE, json, uriInfo);
	...
	public String delete(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.GROUP_DELETE, json, uriInfo);
	...
	public String purge(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.GROUP_PURGE, json, uriInfo);
	...
	public String update(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.GROUP_UPDATE, json, uriInfo);
	...
	public String patch(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.GROUP_PATCH, json, uriInfo);
