...
public class User {
	...
	public String show(@Context UriInfo uriInfo){
		...
		return CatalogueUtils.delegateGet(caller, context, Constants.USER_SHOW, uriInfo);
	...
	public String create(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.USER_CREATE, json, uriInfo);
	...
	public String delete(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.USER_DELETE, json, uriInfo);
	...
	public String update(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return CatalogueUtils.delegatePost(caller, context, Constants.USER_UPDATE, json, uriInfo);
