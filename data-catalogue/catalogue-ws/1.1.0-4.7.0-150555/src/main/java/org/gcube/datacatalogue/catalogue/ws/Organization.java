...
public class Organization {
	...
	public String show(@Context UriInfo uriInfo){
		...
		return Delegator.delegateGet(caller, context, Constants.ORGANIZATION_SHOW, uriInfo);
	...
	public String organizationList(@Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegateGet(caller, context, Constants.ORGANIZATION_LIST, uriInfo);
	...
	public String create(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.ORGANIZATION_CREATE, json, uriInfo);
	...
	public String delete(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.ORGANIZATION_DELETE, json, uriInfo);
	...
	public String purge(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.ORGANIZATION_PURGE, json, uriInfo);
	...
	public String update(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.ORGANIZATION_UPDATE, json, uriInfo);
	...
	public String patch(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.ORGANIZATION_PATCH, json, uriInfo);
