...
public class Resource {
	...
	public String show(@Context UriInfo uriInfo){
		...
		return Delegator.delegateGet(caller, context, Constants.RESOURCE_SHOW, uriInfo);
	...
	public String create(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.RESOURCE_CREATE, json, uriInfo);
	...
	public String create(
		...
		String context = ScopeProvider.instance.get();		
		try{
			return Delegator.delegatePost(caller, context, Constants.RESOURCE_CREATE, multiPart, uriInfo);
		}catch(Exception e){
	...
	public String delete(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.RESOURCE_DELETE, json, uriInfo);
	...
	public String update(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.RESOURCE_UPDATE, json, uriInfo);
	...
	public String patch(String json, @Context UriInfo uriInfo){
		...
		Caller caller = AuthorizationProvider.instance.get();
		String context = ScopeProvider.instance.get();
		return Delegator.delegatePost(caller, context, Constants.RESOURCE_PATCH, json, uriInfo);
