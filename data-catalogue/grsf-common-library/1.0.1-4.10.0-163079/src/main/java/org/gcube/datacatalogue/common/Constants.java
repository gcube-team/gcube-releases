...
public class Constants {
	...
	//	public static final String CONNECTED_RECORD_SEMANTIC_IDENTIFIER_JSON_KEY = "semantic_identifier";
	//	public static final String CONNECTED_RECORD_SHORT_NAME_JSON_KEY = "short_name";
	//	public static final String CONNECTED_RECORD_KNOWLEDGE_BASE_ID_JSON_KEY = "knowledge_base_id";
