...
public class ResourceMapServlet extends HttpServlet {
	...
	private static final Logger logger = LoggerFactory.getLogger(ResourceMapServlet.class);
	...
	protected void handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(resIdString==null){				
			...
			try{
				...
				response.getWriter().write(dataManagement().build().getReport(CSVUtils.CSVToStringList(resIdString)).getResourcesMap());
			}catch(Exception e){
