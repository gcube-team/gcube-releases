...
public class WindowsLiveMyService extends DefaultApiMy{
	...
	private WindowsLiveMyService() {
    }
	
	private static class InstanceHolder {
		private static final WindowsLiveMyService INSTANCE = new WindowsLiveMyService();
	}

	public static WindowsLiveMyService instance() {
