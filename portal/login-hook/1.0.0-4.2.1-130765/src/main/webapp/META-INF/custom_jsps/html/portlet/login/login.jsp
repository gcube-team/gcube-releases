...
<script> window.jQuery || document.write('<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js" type="text/javascript"><\/script>')</script>
<script type="text/javascript" src="/html/portlet/login/js/bootstrap-collapse.js"></script>
<script type="text/javascript" src="/html/portlet/login/js/bootstrap-transition.js"></script>
<script type="text/javascript" src="/html/portlet/login/js/login-hook.js"></script>
			...
			<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="fm">
				...
				<aui:fieldset>
					...
					<div class="custom-form-login-wrapper">
						<aui:input autoFocus="<%= windowState.equals(LiferayWindowState.EXCLUSIVE) || windowState.equals(WindowState.MAXIMIZED) %>" cssClass="clearable login-identifier input-xlarge" placeholder="<%= loginLabel %>" label="" name="login" showRequiredLabel="<%= false %>" type="text">
							<aui:validator name="required" />
						</aui:input>
						
						<aui:input name="password" placeholder="password" cssClass="login-password input-xlarge" label="" showRequiredLabel="<%= false %>" type="password" value="<%= password %>">
							<aui:validator name="required" />
						</aui:input>
						
						<aui:button type="submit" cssClass="login-sign-in-button input-xlarge" value="sign-in" />
				...
				<div class="accordion" id="accordion" role="tablist">
					 <div class="accordion-group">
					   <div class="accordion-heading">
				       		<a data-toggle="collapse" data-parent="#accordion" href="#collapseMe" aria-expanded="true" aria-controls="collapseMe">
				       			<h4><i class="icon-double-angle-up"></i></h4>
				       		</a>
					   </div>
