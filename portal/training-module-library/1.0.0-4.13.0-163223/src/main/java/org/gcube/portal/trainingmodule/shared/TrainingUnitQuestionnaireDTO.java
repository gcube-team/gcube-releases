...
/**
 * The Class TrainingUnitQuestionnaireDTO.
 *
 * @author Francesco Mangiacrapa francesco.mangiacrapa@isti.cnr.it
 * Jan 25, 2018
 */
public class TrainingUnitQuestionnaireDTO implements Serializable{
	 ...
	 */
	public TrainingUnitQuestionnaireDTO() {
	...
	/**
	 * Instantiates a new training unit questionnaire DTO.
	 *
	 ...
	 */
	public TrainingUnitQuestionnaireDTO(String title, String description, String questionnaireId,
	 ...
	 * @param questionnaireURL the questionnaire URL
	 */
	public TrainingUnitQuestionnaireDTO(long internalId, String title, String description, String questionnaireId,
			String questionnaireURL) {
		super();
