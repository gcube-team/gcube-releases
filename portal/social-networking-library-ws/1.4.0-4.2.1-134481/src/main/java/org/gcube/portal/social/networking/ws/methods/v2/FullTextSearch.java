...
@Api(tags={"full-text-search"}, protocols="https", authorizations={@Authorization(value=RequestsAuthFilter.AUTH_TOKEN)})
public class FullTextSearch {
	...
	public Response searchByQuery(
		...
		try{
			...
			List<GCubeGroup> userContexts = new LiferayGroupManager().listGroupsByUser(currentGroupId);
