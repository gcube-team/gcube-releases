 ...
 */
@Path("2/messages")
@Api(tags={"/2/messages"}, description="Endpoint for messages resources", protocols="https", authorizations={@Authorization(value=RequestsAuthFilter.AUTH_TOKEN)})
public class Messages {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful write a message, reported in the 'result' field of the returned object", response = ResponseBean.class),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful read sent messages, reported in the 'result' field of the returned object", response = ResponseBean.class),
			@ApiResponse(code = 500, message = ErrorMessages.errorMessageApiResult, response=ResponseBean.class)})
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful read received messages, reported in the 'result' field of the returned object", response = ResponseBean.class),
			@ApiResponse(code = 500, message = ErrorMessages.errorMessageApiResult, response=ResponseBean.class)})
