 ...
 */
@Path("2/hashtags")
@Api(tags={"/2/hashtags"}, description="Endpoint for hashtags resources", protocols="https", authorizations={@Authorization(value=RequestsAuthFilter.AUTH_TOKEN)})
public class HashTags {
	...
	@ApiOperation(value = "Retrieve hashtags", 
