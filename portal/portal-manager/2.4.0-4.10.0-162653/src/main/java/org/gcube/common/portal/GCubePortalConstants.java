...
public class GCubePortalConstants {
	...
	public static final String QUESTIONNAIRE_MANAGER_FRIENDLY_URL = "/questionnaire-manager";
	public static final String QUESTIONNAIRE_TAKE_FRIENDLY_URL = "/take-the-survey";
	...
	public static final String VRE_ADMINISTRATION_URL = "/administration";
