...
set LOCAL_OPTS=-DGLOBUS_LOCATION="%GLOBUS_LOCATION%" -DANT_HOME="%ANT_HOME%" -Djava.endorsed.dirs="%GLOBUS_LOCATION%\endorsed"
...
%_RUNJAVA%  %LOCAL_OPTS% %GLOBUS_OPTIONS% -classpath %LOCALCLASSPATH% org.globus.bootstrap.AntBootstrap -glfilter wsrf_common.jar org.globus.tools.gar.UndeployGar %CMD_LINE_ARGS%
