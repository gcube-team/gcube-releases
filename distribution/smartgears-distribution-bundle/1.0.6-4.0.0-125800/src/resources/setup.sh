...
SMARTGEAR_DISTRIBUTION_DIRECTORY="smartgears-distribution-*"
SMARTGEAR_ROOT=${PWD}
...
if [ $force ]; then
	...
	ln -s apache-tomcat-* ${TOMCAT_DST_FOLDER}
	echo "done."
	...
	echo -e "\n"
	echo -e "Entering on SmartGear distribution directory\n"
	...
	echo "ln -s apache-tomcat-* ${TOMCAT_DST_FOLDER}"
