...
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/tags/tagsDatatable.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/tags/tagsManagement.css'>

<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/import/importMonitorDatatable.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/import/importMonitor.css'>

<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/import/geotiff/geotiffImporter.css'>

<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/styles/stylesDatatable.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/modules/styles/stylesManagement.css'>
...
<script src='<%=request.getContextPath()%>/script/usersListing.js'></script>
...
<script defer="defer" type="text/javascript">
	(function() {
		$(document).ready(function () {
			...
			var resourceURL = '<portlet:resourceURL id="{url}" />';
 			...
 			<ul class="nav nav-tabs">
   				...
   				<li class="importTab">
   					<a href="#tab3" data-toggle="tab">
   						...
   						<span class="description row">Upload data and create information layers</span>
   					</a>
   				</li>
   				<li class="usersTab">
   					<a href="#tab4" data-toggle="tab">
   						<span class="title row">Users</span>
   						<span class="description row">Report</span>
   					</a>
   				</li>
 			</ul>	
		</div>
