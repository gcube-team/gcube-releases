	...
	var layers = {
	    ...
	    deleteLayer : function(layer) {
		    ...
		    $.ajax({
		        ...
		        success : function(message) {
                    var refreshCallback = function() {
                        layers.showMessage("Layer " + layerName + " has been deleted successfully!", "success");
                    };
                    layers.reloadDataTable(refreshCallback);  
		        },
		        error : function(jqXHR, exception) {
	    ...
	    editLayer : function(layer) {
		    ...
		    $.ajax({
		        ...
		        success : function(message) {
	        		var refreshCallback = function() {
				        layers.showMessage( "Layer " + layerName + " has been updated successfully!", "success");
			        };
			        layers.reloadDataTable(refreshCallback);			        
		        },
		        error : function(jqXHR, exception) {
	    ...
	    initUIbindings : function() {
		    ...
		    $(document.body).on("click", "#geoadmin-layers-edit-modal-delete", function() {
