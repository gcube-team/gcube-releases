...
<p id="geoadmin-layers-notificator" style="display: none;"></p>
...
<div align='center' style='display: inline-block;' class="portlet-datatable-toolbar" id="geoadmin-layers-toolbar">
	<div align='center' style='display: inline-block;' class="portlet-datatable-buttons">
		...
		<button type='button' id='geoadmin-layers-render-button' class="toggle-on-row-selection" data-toggle='modal' data-target='#geoadmin-layers-render-modal' disabled>
			<i class="fa fa-globe" aria-hidden="true"></i> Render in Map
		</button>
		...
		<form class="form-horizontal" id="geoadmin-layers-edit-form" autocomplete="off">
			...
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text" id="geoadmin-layers-edit-name" name="layersName" placeholder="Please give a name"  class="span11" > 
			...
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text" id="geoadmin-layers-edit-creator" name="layersCreator"  class="span11" readonly> 
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text" id="geoadmin-layers-edit-created" name="layersCreated" class="span11" readonly> 
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text" id="geoadmin-layers-edit-geocode-system" name="layersGeocodeSystem" class="span11"  readonly> 
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text" id="geoadmin-layers-edit-is-template" name="layersIsTemplate" class="span11" readonly> 
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
				...
				<div class="controls"class="span8">
					<select id="geoadmin-layers-edit-style" name="layerstyle"  class="span11"></select> 
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
	...
	<div class="modal-body">
		<form class="form-horizontal" id="geoadmin-layers-add-external-form" autocomplete="off">
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text"  id="geoadmin-layers-add-external-geoserver-url" name="geoserverUrl" placeholder="Please give a Geoserver URL" class="span11" >
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input type="text" id="geoadmin-layers-add-external-workspace" name="workspace" placeholder="Please give a workspace" class="span11">
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" class="span12">
				...
				<div class="controls" class="span8">
					<input  type="text" id="geoadmin-layers-add-external-name" name="name" placeholder="Please give a name"  class="span11" > 
					<span class="help-inline"></span>
				</div>
			</div>
		</form>
...
<div id="edit-layer-visualization-modal" class="modal fade"
	hidden="true" tabindex="-1" role="dialog">
	<div class="modal-header">
		<div id="blueLineBottom">
			<span>Preview attributes for layer </span>
			<span id="layerVisualizationHeader"></span>
	...
	<div class="modal-body">
		<div id="geoadmin-layers-attributes">
			...
			<div align='center' style='display: inline-block;' 
				class="portlet-datatable-toolbar" id="geoadmin-layers-attributes-toolbar">
			</div>
	...
	<div class="modal-footer">
		<button id="geoadmin-layer-visualization-submit"
			 class="btn portlet-button pull-left" data-dismiss="modal" aria-hidden="true">OK</button>
		<button class="btn portlet-button" data-dismiss="modal" aria-hidden="true">Close</button>
	</div>
</div>

<div align='center' style='display: inline-block;'
	class="portlet-datatable-toolbar" id="geoadmin-layers-toolbar">
</div>