$.widget('cite.shapefileImporter', {	
		...
		<div class="span6">
			...
			<form class="form-horizontal" id="shapefileimporter-form-data">	
				...
				<div class="control-group row">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-layername"  class="span12"  name="layerName"  placeholder="Please fill in your layer name" rows="1"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row">
					<div class="span4">
						<label for=""shapefileimporter-template-layer"">Is Template Layer</label>
					</div>
					<div class="span8">						
						<input type="checkbox" id="shapefileimporter-template-layer">
						<label for="shapefileimporter-template-layer"></label>
					</div>
				</div>
				
				<div class="control-group row" style="display:none; margin-top:20px;">
					<div class="span4">
						<label for="shapefileimporter-template-layer" style="padding-left:20px;">
							Template Layer Geocode System<span class="makeMeOrange">*</span>
						</label>
					</div>
					<div class="span8">
						<textarea style="resize: none;" 
							id="shapefileimporter-template-layer-geocode-system" 
							class="span12" 
							rows="1" 
				...
				<div class="control-group row" style="display:none;">
					...
					<div class="span8">
						<textarea style="resize: none;" 
							id="shapefileimporter-template-layer-geocode-mapping" 
							class="span12" 
							rows="2" 
				...
				<div class="control-group row">
					<div class="span4">
						<label for=""shapefileimporter-style"">Style<span class="makeMeOrange">*</span></label>
					</div>
					<div class="span8">
						<select id="shapefileimporter-style" class="span12"  name="style">
			...
			<form class="form-horizontal" id="shapefileimporter-form-description">									
				...
				<div class="control-group row" id="generalPurpose">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-purpose" name="purpose" class="span12" placeholder="Please fill in the layer purpose" rows="2"></textarea>
					</div>
				</div>
				...
				<div class="control-group row" id="generalKeywords">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-tagsinput" name="tagsInput" class="span12" placeholder="Please fill in the layer keywords" rows="1"></textarea>
					</div>
				</div>
				...
				<div class="control-group row" id="generalLimitations">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-limitation" name="limitation" class="span12" placeholder="Please fill in the layer limitations" rows="2"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			</form>
		...
		<div class="span6">
			...
			<form class="form-horizontal" id="shapefileimporter-author-metadata" >
				<div class="control-group row" id="authorOrganization">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-author-organisationname" name="organisationName" class="span12" rows="1"  placeholder="Please fill in the organisation's name"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			</form>								
			...
			<form class="form-horizontal" id="shapefileimporter-distributor-metadata" >									
				<div class="control-group row" id="distributorOrg">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-distributor-organisationname" name="organisationName" class="span12" rows="1"  placeholder="Please fill in the organisation's name"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="distributorDistributors">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-distributor-individualname" name="individualName" class="span12" rows="1" placeholder="Please fill in the distributor name(s)"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="distributorUrl">
					...
					<div class="span8">
						<textarea style="resize: none;" class="span12" 
			...
			<form class="form-horizontal" id="shapefileimporter-provider-metadata" >									
				<div class="control-group row" id="providerOrganization">
					...
					<div class="span8">
						<textarea style="resize: none;" 	id="shapefileimporter-provider-organisationname" name="organisationName" class="span12" rows="1" placeholder="Please fill in the organisation's name"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="providerProviders">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-provider-individualname"  name="individualName" class="span12" rows="1" placeholder="Please fill in the provider name(s)"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="providerURL">
					...
					<div class="span8">
						<textarea style="resize: none;" id="shapefileimporter-provider-onlineresource" name="onlineResource" class="span12" rows="1" placeholder="Please fill in the URL of provision"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			</form>								
	...
	_initializeFunctionality : function (){		
		...
		$(document).ready(function(){
			...
			$("#shapefileimporter-template-layer").change(function() {
				$("#shapefileimporter-template-layer-geocode-system").closest(".control-group").toggle();
				$("#shapefileimporter-template-layer-geocode-mapping").closest(".control-group").toggle();
			});			
		});		
		...
		$(document).ready(function() {
			...
			$.ajax({
				...
				success: function(response) {
					$.each(response, function(i,v){
						...
						$('#shapefileimporter-style').append($option);
					});
			...
			$('#shapefileimporter-import-button').on('click',function (e){				
				...
				if(validDescription && validAuthorMetadata && validDistributorMetadata && validProviderMetadata && validData){				
					var spans = $('#shapefileimporter-container .tagsinput').find(".tag > span");
					var tags = [];
					...
					importFormData.append("shapefileImportProperties", new Object([JSON.stringify({
						...
						"geocodeSystem"		:	$("#shapefileimporter-template-layer-geocode-system").val(),
						"geocodeMapping"	:	$("#shapefileimporter-template-layer-geocode-mapping").val(),
						"isTemplate"		:	$("#shapefileimporter-template-layer").is(":checked") ? true : false,
						"style"				:   $('#shapefileimporter-style option:selected').text()
					})], {
						type: "application/json"
					}));
					
					importFormData.append("shapefileImportMetadata", new Object([JSON.stringify({
						"description"		: 	$('#shapefileimporter-abstract').val().trim(),
