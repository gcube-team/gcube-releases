		...
		<div class="span6">
			...
			<form class="form-horizontal" id="tsvimporter-form-data">	
				...
				<div class="control-group row">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-layername"  class="span12"  name="layerName"  placeholder="Please fill in your Layer Name" rows="1"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			...
			<form class="form-horizontal" id="tsvimporter-form-description">									
				...
				<div class="control-group row" id="generalPurpose">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-purpose" name="purpose" class="span12" placeholder="Please fill in the layer purpose" rows="2"></textarea>
					</div>
				</div>
				...
				<div class="control-group row" id="generalKeywords">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-tagsinput" name="tagsInput" class="span12" placeholder="Please fill in the layer keywords" rows="1"></textarea>
					</div>
				</div>
				...
				<div class="control-group row" id="generalLimitations">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-limitation" name="limitation" class="span12" placeholder="Please fill in the layer limitations" rows="2"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			</form>
		...
		<div class="span6">
			...
			<form class="form-horizontal" id="tsvimporter-author-metadata" >
				<div class="control-group row" id="authorOrganization">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-author-organisationname" name="organisationName" class="span12" rows="1" placeholder="Please fill in the organisation name"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			</form>								
			...
			<form class="form-horizontal" id="tsvimporter-distributor-metadata" >									
				<div class="control-group row" id="distributorOrg">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-distributor-organisationname" name="organisationName" class="span12" rows="1" placeholder="Please fill in the organisation name"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="distributorDistributors">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-distributor-individualname" name="individualName" class="span12" rows="1" placeholder="Please fill in the distributor name(s)"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			...
			<form class="form-horizontal" id="tsvimporter-provider-metadata" >									
				<div class="control-group row" id="providerOrganization">
					...
					<div class="span8">
						<textarea style="resize: none;" id="tsvimporter-provider-organisationname" name="organisationName" class="span12" rows="1" placeholder="Please fill in the organisation name"></textarea>						
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="providerProviders">
					...
					<div class="span8">
						<textarea  style="resize: none;" id="tsvimporter-provider-individualname"  name="individualName" class="span12" rows="1" placeholder="Please fill in the provider name(s)"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				...
				<div class="control-group row" id="providerURL">
					...
					<div class="span8">
						<textarea style="resize: none;" id="tsvimporter-provider-onlineresource" name="onlineResource" class="span12" rows="1" placeholder="Please fill in the URL of provision"></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
			</form>								
