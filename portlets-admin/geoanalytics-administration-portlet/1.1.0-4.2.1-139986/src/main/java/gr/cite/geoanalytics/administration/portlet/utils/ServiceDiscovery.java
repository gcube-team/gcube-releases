...
import gr.cite.geoanalytics.administration.portlet.GeoanalyticsAdministrationHome;
import gr.cite.geoanalytics.administration.portlet.utils.exceptions.ServiceDiscoveryException;
...
public class ServiceDiscovery {
	...
	public static String fetchServiceEndpoint(String scope, ServiceProfile serviceProfile) throws Exception {		
		System.out.println("Trying to discover Geoanalytics Service ...");
		...
		_log.info("Managed to discover " + serviceProfile.getServiceName() + " endpoint " + endpoint);
