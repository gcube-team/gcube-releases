(function (){
	...
	var config = {
		...
		init : function(args) {
			...
			theData[this.nameSpace + 'getPluginsTabVisibility'] = true;
			...
			$.ajax(
				{
					...
					success: function(data) {
						...
						config.isPluginTabsVisible = jsonResponse.pluginsTabVisibility;
						
						window.layers.init();
						window.tags.init();
						window.importMonitor.init();
						window.styles.init();
						window.plugins.init(config.isPluginTabsVisible);
