...
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/tsv-importer/tsv-importer-widget.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/wfs-importer/wfs-importer-widget.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/shapefile-importer/shapefile-importer-widget.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/geotiff-importer/geotiff-importer-widget.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/netcdf-importer/netcdf-importer-widget.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/geojson-importer/geojson-importer-widget.css'>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/script/codemirror/lib/codemirror.css'>
...
<script src='<%=request.getContextPath()%>/script/FileSaver.js'></script>
<script src='<%=request.getContextPath()%>/script/common/notificator.js'></script>

<script src='<%=request.getContextPath()%>/widgets/tsv-importer/tsv-importer-widget.js'></script>
<script src='<%=request.getContextPath()%>/widgets/wfs-importer/wfs-importer-widget.js'></script>
<script src='<%=request.getContextPath()%>/widgets/shapefile-importer/shapefile-importer-widget.js'></script>
<script src='<%=request.getContextPath()%>/widgets/geotiff-importer/geotiff-importer-widget.js'></script>
<script src='<%=request.getContextPath()%>/widgets/geojson-importer/geojson-importer-widget.js'></script>
<script src='<%=request.getContextPath()%>/widgets/netcdf-importer/netcdf-importer-widget.js'></script>
...
<script defer="defer" src='<%=request.getContextPath()%>/modules/layers/layers-management.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/modules/layers/attributeVisualization.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/modules/tags/tags-management.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/modules/import/import-monitor.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/modules/config/config.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/modules/styles/styles-management.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/modules/styles/styles-editor-functions.js'></script>
...
<script defer="defer" src='<%=request.getContextPath()%>/widgets/styled-checkbox/styled-checkbox-widget.js'></script>
<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/widgets/styled-checkbox/styled-checkbox-widget.css'>

<script defer="defer" src='<%=request.getContextPath()%>/modules/geonetwork/geonetwork-form.js'></script>

<!-- plugin for xml text editors -->
<script defer="defer" src='<%=request.getContextPath()%>/script/codemirror/lib/codemirror.js'></script>
<script defer="defer" src='<%=request.getContextPath()%>/script/codemirror/mode/xml/xml.js'></script>
	...
	<div class="tabbable navbarTop">   				
		<div class="row">  				
 			<ul class="nav nav-tabs">
   				...
   				<li class="pluginsTab" style="display: none;">
