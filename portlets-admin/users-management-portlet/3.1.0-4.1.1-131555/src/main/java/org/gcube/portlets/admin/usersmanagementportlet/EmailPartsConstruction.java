...
public class EmailPartsConstruction {
	...
	public static String subjectForMembershipRequestAcceptanceOrRejection(
			String subjectProperty, String portalComplete, String groupName){
		
		String subject = returnProperty(subjectProperty);
		if(subject != null){
			String finalString = portalComplete +" - " + groupName;
	...
	public static String subjectForUserDismissalFromSite(
			String subjectProperty, String portalComplete, String groupName){
		System.out.println(portalComplete + " : " + groupName);
		return subjectForMembershipRequestAcceptanceOrRejection(subjectProperty, portalComplete, groupName);
	}
