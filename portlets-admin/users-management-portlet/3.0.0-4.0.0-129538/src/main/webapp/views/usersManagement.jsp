...
<div class="tab-content" id="tabsForTables">
	<div class="tab-pane userManagementTab unhit" id="userManagementTab">
		...
		<div id="usersManagementPortletContainer">
			...
			<div id="element" class="introLoading" hidden="true"></div>
					...
					<table id="CurrentUsersTable" class="no-wrap " style="width: 100%;">
						<thead>
							<tr role="row">
								<th>
									<div style="padding-left:8px;">all</div>
								</th>
								<th>
									username
								</th>
			...
			<div id="changeUsersRolesModal" class="modal fade in" hidden="true"> <!-- style="width:700px;"> -->
			  <div class="modal-header">
			  	<div id="changeUsersRolesModalHeaderDiv">
			  		<div class="modalHeaderContainer">
			  			<span id="theHeader">mass edit selected users</span>
			  ...
			  <div class="modal-body">
			  	<div id="auxilliaryDiv">
				  	<span id="textAboveTagsInput">
				  		...
				  		<div id="multipleTagsSection" class="hiddenSection">
			  ...
			  <div class="modal-footer">
			    <button id="saveUsersRolesModal" class="btn btn-link">Save</button>
			    <button id="closeUsersRolesModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
			  </div>
			</div>
			
			<div id="assignUsersRolesModal" class="modal fade in" hidden="true"> <!-- style="width:700px;"> -->
			  <div class="modal-header">
			  	<div id="changeUsersRolesModalHeaderDiv">
				  	<div class="modalHeaderContainer">
			  ...
			  <div class="modal-body">
			  	<div id="auxilliaryDivInAssignRolesModal">
				  	<span id="textAboveTagsInputInAssignRolesModal">
				  		...
				  		<div id="multipleTagsSectionInAssignRolesModal" class="hiddenSection">
				  			<p id="multipleUsersRole">Selected roles will be granted to all users, if they are not already associated to them.</p>
				  		</div>
				  		<br>
				  		<br>
			  ...
			  <div class="modal-footer">
			    <button id="saveUsersRolesModalInAssignRolesModal" class="btn btn-link">Save</button>
			    <button id="closeUsersRolesModalInAssignRolesModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
			  </div>
			</div>
			
			<div id="assignUsersToGroupsModal" class="modal fade in" hidden="true"> <!-- style="width:700px;"> -->
			  <div class="modal-header">
			  	<div id="changeUsersRolesModalHeaderDiv">
			  		<div class="modalHeaderContainer">
			  ...
			  <div class="modal-body">
			  	<div id="auxilliaryDiv">
				  	<span id="textAboveTagsInputInAssignUsersToGroupsModal">
				  		...
				  		<div id="multipleTagsSectionInAssignUsersToGroupsModal" class="hiddenSection">
			  ...
			  <div class="modal-footer">
			    <button id="saveUsersTeamsInAssignUsersToGroupsModal" class="btn btn-link">Save</button>
			    <button id="closeUsersTeamsInAssignUsersToGroupsModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
			  </div>
			</div>
			...
			<div id="usersRequestsModal" class="modal fade" hidden="true"> <!-- style="width:700px;"> -->
			  <div class="modal-header">
				<div class="modalHeaderContainer">
					<span id="userRequestsHeader">users' requests <a id="reloadUsersRequestsTable" class="btn" data-toggle = "tooltip" data-placement = "right" data-original-title = "Refreshs users' membership requests table"><i id="refreshIcon" class="icon-refresh"></i></a></span>
			  		<div class="modalSubHeader">Grant/deny access to the VRE</div>
				</div>
			    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			  </div>
			  <div class="modal-body">
			  ...
			  <div class="modal-footer">
			  	<button id="sendAcceptance" class="btn btn-link allButtons hideButton">Send acceptance</button>
			  	<button id="sendRejection" class="btn btn-link allButtons hideButton">Reject</button>
			    <button id="acceptAll" class="btn btn-link allButtons">Accept All</button>
			    <button id="rejectAll" class="btn btn-link allButtons">Reject All</button>
			    <button id="closeUsersRolesModal" class="btn btn-link">Cancel</button>
			  </div>
			</div>
			
			<div id="acceptUsersRequestsModal" class="modal fade" hidden="true">
			  <div class="modal-header">
				<div id="blueLineBottom">
				  	<div class="modalHeaderContainer">
			  ...
			  <div class="modal-footer">
			    <button id="acceptUsersRequestsOk" class="btn btn-link">OK</button>
			    <button id="closeUsersRolesModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
			  </div>
			</div>
			
			<div id="deleteUsersFromCurrentSiteModal" class="modal fade" hidden="true">
			  <div class="modal-header">
			  	<div id="blueLineBottom">
				  	<div class="modalHeaderContainer">
			  ...
			  <div class="modal-footer">
			    <button id="acceptDeleteUsersFromCurrentSiteModal" class="btn btn-link">OK</button>
			    <button id="closeDeleteUsersFromCurrentSiteModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
			  </div>
			</div>
			
			<div id="userDetailsModal" class="modal fade" hidden="true">
			  <div class="modal-header">
			  	<div id="blueLineBottom">
				  	<div class="modalHeaderContainer">
			  ...
			  <div class="modal-footer">
			    <button id="closeUSerDetailsModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Close</button>
			  </div>
			</div>
			
			<div id="cannotRemoveSelfModal" class="modal fade" hidden="true">
			  <div class="modal-header">
			  	<div id="blueLineBottom">
	...
	<div id="displayGroupTeamUsersModal" class="modal fade" hidden="true" tabindex="-1" role="dialog">
	  ...
	  <div class="modal-footer">
		<button id="assignUsersToGroupModalBtn" class="btn btn-link">Add Users</button>
		<button id="closeGroupTeamUsersModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Close</button>
	  </div>
	</div>
	...
	<div id="editGroupTeamModal" class="modal fade" hidden="true" tabindex="-1" role="dialog">
	  ...
	  <div class="modal-footer">
	    <button id="acceptEditGroupTeamOk" class="btn btn-link">OK</button>
	    <button id="closeEditGroupModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
	  </div>
	</div>
	...
	<div id="deleteGroupTeamModal" class="modal fade" hidden="true" tabindex="-1" role="dialog">
	  ...
	  <div class="modal-footer">
	    <button id="acceptDeleteGroupTeamOk" class="btn btn-link">OK</button>
	    <button id="closeDeleteGroupTeamModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
	  </div>
	</div>
	...
	<div id="newGroupTeamModal" class="modal fade" hidden="true" tabindex="-1" role="dialog">
	  ...
	  <div class="modal-footer">
	    <button id="acceptCreateGroupTeamOk" class="btn btn-link">OK</button>
	    <button id="closeCreateGroupModal" class="btn btn-link" data-dismiss="modal" aria-hidden="true">Cancel</button>
	  </div>
	</div>
...
$(document).ready(function () {
	...
	List<Role> siteRoles = RoleLocalServiceUtil.getRoles(2, StringPool.BLANK);
	for(Role sr : siteRoles){%>
		theList.push('<%=sr.getName()%>');
		<%}
