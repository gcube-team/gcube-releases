	...
	private void createMultiAxisChart() {
		...
		if (accountingStateData.getSeriesRequest().getAccountingPeriod()
			...
			for (SeriesJobData seriesJobData : seriesJobBasic.getSeries()) {
				...
				dataOperationCount.y(seriesJobData.getOperationCount());
				...
				dataDuration.y(seriesJobData.getDuration() / unitMeasure);
				...
				dataMaxInvocationTime.y(seriesJobData.getMaxInvocationTime()
						/ unitMeasure);
				...
				dataMinInvocationTime.y(seriesJobData.getMinInvocationTime()
						/ unitMeasure);
