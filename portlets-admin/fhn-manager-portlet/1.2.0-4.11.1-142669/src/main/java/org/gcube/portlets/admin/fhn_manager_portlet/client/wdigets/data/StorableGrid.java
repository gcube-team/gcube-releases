...
//		theGrid.setBordered(true);
	...
	public void fireRefreshData() {
		RefreshGridOptions options=getRefreshOption();
		FhnManagerController.eventBus.fireEvent(new RefreshGridEvent(options,new RetrievedGridElementsEvent(this,options.getType())));
	}
