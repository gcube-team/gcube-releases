...
//		thePanel.setBorderWidth(2);
		...
		buttonBar.setVisibleState(ButtonBarElement.CREATE, configuration.isEnableCreate());
		buttonBar.setVisibleState(ButtonBarElement.DELETE, configuration.isEnableRemove());
...
//	}
	...
	public RefreshGridEvent getRefreshEvent(){
		RefreshGridOptions options=theGrid.getRefreshOption();
		return new RefreshGridEvent(options, new RetrievedGridElementsEvent(this,options.getType()));
	}
