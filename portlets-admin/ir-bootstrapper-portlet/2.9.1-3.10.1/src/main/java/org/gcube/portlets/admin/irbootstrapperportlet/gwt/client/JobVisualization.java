 ...
 *
 */
public class JobVisualization extends Composite {
	...
	private static final int NODE_WIDGET_WIDTH = 80;
	private static final int NODE_WIDGET_HEIGHT = 80;
	...
	public JobVisualization(JobUIElement job) {
	...
	public JobVisualization(JobUIElement job, int height, boolean bShowLegend) {
		this.visualizedJob = null;
		this.updateTimer = null;
		this.visualizedJobChangeListener = null;
		this.viewMode = JobViewMode.MODE_AVAILABLE;
