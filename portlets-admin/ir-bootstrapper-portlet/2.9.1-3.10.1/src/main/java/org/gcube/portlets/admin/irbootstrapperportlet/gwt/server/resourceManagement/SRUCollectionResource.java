 ...
 *
 */
public class SRUCollectionResource extends GCUBEResource {
	
	public static final String TYPE_NAME = "SRUCollectionType";
	 ...
	 * @param baseISQuery
	 */
	public SRUCollectionResource(String scope) {
		...
		this.setAttributeValue(ATTR_TYPE, "sru");
	}
