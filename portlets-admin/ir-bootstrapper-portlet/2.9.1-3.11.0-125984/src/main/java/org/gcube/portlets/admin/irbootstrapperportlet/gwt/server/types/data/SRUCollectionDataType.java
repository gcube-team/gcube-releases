...
import org.gcube.portlets.admin.irbootstrapperportlet.gwt.server.resourceManagement.SRUCollectionResource;
 ...
 *
 */
public class SRUCollectionDataType extends DataType<SRUCollectionResource> {
	...
	/** Logger */
	private static Logger logger = Logger.getLogger(SRUCollectionDataType.class);
	
	/**
	 * Class constructor
	 * @throws Exception
	 */
	public SRUCollectionDataType(String scope, SRUCollectionResource associatedResource) throws Exception {
		super(scope, associatedResource, SRUCollectionResource.class);
	...
	public Map<String, String> getDataTypeAttrToResourceAttrMappings() {
		...
		ret.put(ATTR_COLLECTIONNAME, SRUCollectionResource.ATTR_COLLECTIONNAME);
		ret.put(ATTR_COLID, SRUCollectionResource.ATTR_ID);
		ret.put(ATTR_COLDESC, SRUCollectionResource.ATTR_COLLECTIONDESC);
		ret.put(ATTR_COLTYPE, SRUCollectionResource.ATTR_TYPE);
		ret.put(ATTR_COLISUSER, SRUCollectionResource.ATTR_ISUSER);
		return ret;
	}
	...
	public boolean doesIdentifyUniqueResource() {
		...
		try {
			...
			logger.error("Error while trying to retrieve SRUCollectionDataType attribute values.", e);
			return false;
		}
	}
	...
	public String getUID() {
		try {
			return "SRUCollection_" + this.getAttributeValue(ATTR_COLID);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public String getUIName() throws Exception {
		try {
			...
			logger.error("Failed to construct the name of a SRUCollectionDataType instance.", e);
			throw new Exception("Failed to construct the name of a SRUCollectionDataType instance.");
		}
	}
