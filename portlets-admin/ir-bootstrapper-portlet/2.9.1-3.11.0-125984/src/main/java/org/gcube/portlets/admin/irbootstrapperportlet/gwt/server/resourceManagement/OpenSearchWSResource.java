 ...
 *
 */
public class OpenSearchWSResource extends GCUBEResource {
	
	/* A desired name */
	public static final String TYPE_NAME = "OpenSearchResource";
	...
	public static final String ATTR_COLLECTIONID = "/Resource/Profile/Body/openSearchDataSourceResource/collectionID/text()";
