...
import org.gcube.portlets.admin.software_upload_wizard.client.view.card.GCubePluginDataCard;
...
public class GCubePluginWizard extends StrategyWizard {

	public GCubePluginWizard(ArrayList<String> packageIds) {
		super(new ArrayWizard(Arrays.asList(
				new GCubePluginDataCard(packageIds.get(0)),
