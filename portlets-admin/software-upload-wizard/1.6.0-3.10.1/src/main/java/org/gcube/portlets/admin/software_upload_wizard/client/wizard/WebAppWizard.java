...
import org.gcube.portlets.admin.software_upload_wizard.client.view.card.WebAppPackageCard;
import org.gcube.portlets.admin.software_upload_wizard.client.view.card.WebAppServiceCard;
...
public class WebAppWizard extends StrategyWizard {

	public WebAppWizard(ArrayList<String> packageIds) {
		super(new ArrayWizard(Arrays.asList(
				new WebAppServiceCard(),
				new WebAppPackageCard(packageIds.get(0)),
