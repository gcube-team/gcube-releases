...
public class DownloadFolder {
	...
	private static void createLibrary() throws InternalErrorException, HomeNotFoundException, UserNotFoundException, InsufficientPrivilegesException, WorkspaceFolderNotFoundException, ItemAlreadyExistException, WrongDestinationException, ItemNotFoundException, IOException, PathNotFoundException, RepositoryException {
		...
		ws = HomeLibrary
				...
				.getHomeManager()
				.getHome("francesco.mangiacrapa").getWorkspace();

		
//		WorkspaceItem myItem = ws.getItemByPath("/Workspace/00000/test-10dc1f2e-a3e0-415e-b195-899a3d05dbc8");
...
//		for(WorkspaceTrashItem trashItem : trashItems){
//			
//			System.out.println("getName " + trashItem.getName() );
//			System.out.println("getDeletedFrom " + trashItem.getDeletedFrom());
//			System.out.println("******");
//		}
...
//				System.out.println("SHARED ---> " + item.getPath());
				//				System.out.println("SHARED with " +  item.getACLOwner().toString());
			}else
				System.out.println("---> " + item.getPath());
						System.out.println("getName " + item.getName());
						System.out.println("isFolder " + item.isFolder());
						System.out.println("isShared " + item.isShared());
						System.out.println("getOwner " + item.getOwner().getPortalLogin());
						System.out.println("getLastModificationTime " + item.getLastModificationTime().getTime());
...
//				List<? extends WorkspaceItem> childs = item.getChildren();
//				for (WorkspaceItem child: childs){
//					System.out.println("* " + child.getPath());
//				}
			}
			//			System.out.println(item.getPath() + " " + item.getType());
		}
