...
public class ServletName {
	...
	public static final String GET_VERSION_USER 		= "GetVersionServlet";
	...
	public static final String DELETE_FROM_TRASH 		= "DeleteFromTrash";
	
	//versioning
	public static final String DOWNLOAD_VERSION 		= "DownloadVersion";
	public static final String VERSION_HISTORY 			= "VersionHistory";
	public static final String SAVE_CURRENT_VERSION 	= "SaveCurrentVersion";
	...
	public static final Object GET_CHILDREN_COUNT 		= "GetChildrenCount";
