...
public class JCRWorkspaceVRECatalogue extends JCRWorkspaceCatalogue {


	public JCRWorkspaceVRECatalogue(JCRWorkspace workspace, ItemDelegate delegate) throws RepositoryException {
		super(workspace, delegate);
	}

	public JCRWorkspaceVRECatalogue(JCRWorkspace workspace, ItemDelegate myCatalogue, String catalogueFolder,
