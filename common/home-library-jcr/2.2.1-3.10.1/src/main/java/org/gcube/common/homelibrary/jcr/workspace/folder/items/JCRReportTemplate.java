...
ReportTemplate {
	...
	public JCRReportTemplate(JCRWorkspace workspace, ItemDelegate itemDelegate, String name,
			...
			InputStream templateData) throws RepositoryException, RemoteBackendException, FileNotFoundException, InternalErrorException  {
		...
		File tmp = WorkspaceUtil.getTmpFile(templateData);
