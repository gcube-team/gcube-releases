...
public class JCRAccountingEntryModifyACL extends JCRAccountingEntry implements AccountingEntryShare {
	...
	public JCRAccountingEntryModifyACL(AccountingDelegate node) throws RepositoryException {
		super(node);
	...
	public JCRAccountingEntryModifyACL(String id, String user, Calendar date, String itemName, List<String> members) {
		super(id, user, date);
		...
		entryDelegate.setEntryType(AccountingEntryType.MODIFY_ACL);
	}

	@Override
	public AccountingEntryType getEntryType() {
		return AccountingEntryType.MODIFY_ACL;
	}
