...
public class JCRSession {
	...
	public JCRSession() throws RepositoryException{
		this.login = null;
		this.urlRepository = JCRRepository.url;
		sessionId = getSession();
	}
...
//	System.out.println(urlRepository + "/post/CreateReference?" + userInfo() + "&srcId=" + itemId + "&destId=" +destinationFolderId +"&uuid="+sessionId);
			postMethod =  new PostMethod(urlRepository + "/post/CreateReference?" + userInfo() + "&srcId=" + itemId + "&destId=" +destinationFolderId +"&uuid="+sessionId);
...
//			System.out.println(urlRepository + "/get/GetReferences?" + userInfo() + "&srcId=" + itemId + "&uuid="+sessionId);
			getMethod =  new GetMethod(urlRepository + "/get/GetReferences?" + userInfo() + "&srcId=" + itemId + "&uuid="+sessionId);
