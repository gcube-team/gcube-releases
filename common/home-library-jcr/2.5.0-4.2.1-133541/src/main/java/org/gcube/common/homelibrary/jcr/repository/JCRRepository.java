...
public class JCRRepository {
	...
	private static synchronized void initializeRepository() throws InternalErrorException {
		...
		try {
			...
			context = Constants.authorizationService().get(SecurityTokenProvider.instance.get()).getContext();			
...
//				ScopeProvider.instance.set(context);
	...
	public void init() throws Exception{
		...
		logger.info(portalLogin + " - USER VERSION: " + userVersion + " - HL VERSION: " + HL_VERSION);
