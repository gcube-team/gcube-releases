...
//		String scope = "/gcube/preprod/Dorne";
		ScopeProvider.instance.set(scope);
		//				String user = "valentina.marioli";

		ws = (JCRWorkspace) HomeLibrary.getHomeManagerFactory().getHomeManager().getHome("valentina.marioli").getWorkspace();
//		String path = "/Workspace/MySpecialFolders/d4science.research-infrastructures.eu-gCubeApps-SmartArea";

		JCRWorkspaceSharedFolder folder = (JCRWorkspaceSharedFolder) ws.getVREFolderByScope(scope);
		List<WorkspaceItem> list = folder.getLastItems(6);
