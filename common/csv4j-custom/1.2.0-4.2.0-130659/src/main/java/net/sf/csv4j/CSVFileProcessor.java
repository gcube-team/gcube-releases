...
public class CSVFileProcessor
{
     ...
     */
    public int processFile( final String filename, final CSVLineProcessor processor )
            throws IOException, ProcessingException, ParseException
    {
        return this.processor.processStream( new FileReader( filename ), processor );
    }
     ...
     * @throws ParseException if a error occurs parsing the CSV line
     */
    public int processFile( final String filename, final CSVFieldMapProcessor processor )
            throws IOException, ProcessingException, ParseException
    {
        return processFile( filename, new LineToFieldMapAdapter( processor ) );
    }
     ...
     * @throws ParseException if a error occurs parsing the CSV line
     */
    public int processFile( final String filename, final CSVSortedFieldMapProcessor processor )
            throws IOException, ProcessingException, ParseException
    {
        return processFile( filename, new LineToSortedFieldMapAdapter( processor ) );
    }
