...
//    	Map file = (Map)fileObj;
    ...
    public Metafile(InputStream is) throws Exception {
      ...
      //  List folders = (List) info.get(ByteBuffer.wrap("folders".getBytes()));
