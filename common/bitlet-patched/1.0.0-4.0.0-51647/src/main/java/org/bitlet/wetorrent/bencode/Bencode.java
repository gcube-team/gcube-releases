...
public class Bencode {
    ...
    private void print(Object object, OutputStream os) throws IOException {
        ...
        if (object instanceof ByteBuffer) {
            ...
            @SuppressWarnings("unchecked")
			Map<ByteBuffer, Object> map = (Map<ByteBuffer, Object>) object;
            os.write('d');

            SortedMap<ByteBuffer, Object> sortedMap = new TreeMap<ByteBuffer, Object>(new DictionaryComparator());
            // sortedMap.putAll(map);

            for (Entry<ByteBuffer, Object> entry : map.entrySet()) {
                sortedMap.put(entry.getKey(), entry.getValue());
            }

            for (Entry<ByteBuffer, Object> entry : sortedMap.entrySet()) {
