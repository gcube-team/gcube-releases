...
public class StartupTest {
	...
	public void stillStoresProfileWhenPublicationFails() throws Exception {
		...
		when(failingPublisher.create(any(Resource.class),anyListOf(String.class))).thenThrow(new RegistryNotFoundException());
	...
	public void canStartInVreScope() throws Exception {
		...
		String vre = "/"+app.containerConfiguration().infrastructure()+"/"+app.containerConfiguration().startVOs().get(0)+"/vre";
