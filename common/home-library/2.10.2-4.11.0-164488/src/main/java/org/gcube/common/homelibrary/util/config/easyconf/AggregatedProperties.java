...
public class AggregatedProperties extends CompositeConfiguration {
	...
	private Configuration prefixedSystemConfiguration = new SubsetConfiguration(systemConfiguration, getPrefix(), null);
	...
	private Configuration addDatasourceProperties(String datasourcePath) {
		DatasourceURL dsUrl = new DatasourceURL(datasourcePath, companyId, componentName, DatasourceURL.PROPERTIES_TABLE);
