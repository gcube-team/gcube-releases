...
public interface WorkspaceItem {
	 ...
	 * @param shortenUrl
	 * @return an http link for the item
	 * @throws InternalErrorException
	 */
	public String getPublicLink(boolean shortUrl) throws InternalErrorException;
	
	/**
	 * Get a secure (i.e. https) public link for the item
	 * @param shortenUrl
	 * @return a secure https link for the item
	 * @throws InternalErrorException
	 */
	public String getSecurePublicLink(boolean shortenUrl) throws InternalErrorException;
