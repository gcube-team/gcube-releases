...
public class GCubeSearch {
     ...
     * @return
     */
    public ArrayList<String> getResultsFromConsumer(int numOfResConsume, int startOffset, ASLSession aslSession, ResultSetConsumerI resConsumer) {
        ...
        }catch(gRS2ReaderException | gRS2BufferException | gRS2RecordDefinitionException ex){
            this.logger.error("Parameters passed to getResultsToText are: "+" NumOfResultsConsume: "+numOfResConsume +", StartOffset: "+startOffset+"\n"+ex.toString());
        }
