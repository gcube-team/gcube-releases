package org.gcube.portlets.user.dataminerexecutor.shared;
...
public class Constants {
	...
	public static final String APPLICATION_ID = "org.gcube.portlets.user.dataminerexecutor.portlet.DataMinerExecutor";
	public static final String DATA_MINER_EXECUTOR_ID = "DataMinerExecutorId";
	public static final String DATA_MINER_EXECUTOR_LANG_COOKIE = "DataMinerLangCookie";
	public static final String DATA_MINER_EXECUTOR_LANG = "DataMinerLang";
	public static final String DATA_MINER_EXECUTOR_OPERATOR_ID = "OperatorId";
	public static final String DATA_MINER_EXECUTOR_INVOCATION_MODEL = "dim";
