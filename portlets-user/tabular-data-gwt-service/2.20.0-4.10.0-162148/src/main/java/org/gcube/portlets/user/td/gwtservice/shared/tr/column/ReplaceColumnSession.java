...
public class ReplaceColumnSession implements Serializable {
	...
	public String toString() {
		return "ReplaceColumnSession [value=" + value + ", replaceValue=" + replaceValue + ", trId=" + trId
				+ ", columnData=" + columnData + ", rowId=" + rowId + ", replaceDimension=" + replaceDimension + "]";
	}
