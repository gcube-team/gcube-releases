...
public class ResourceTDDescriptor implements Serializable {
	...
	public ResourceTDDescriptor(long id, String name, String description, String creationDate, long creatorId,
			ResourceTDType resourceType, ResourceTD resourceTD) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "ResourceDescriptorTD [id=" + id + ", name=" + name + ", description=" + description + ", creationDate="
				+ creationDate + ", creatorId=" + creatorId + ", resourceType=" + resourceType + ", resourceTD="
				+ resourceTD + "]";
	}
