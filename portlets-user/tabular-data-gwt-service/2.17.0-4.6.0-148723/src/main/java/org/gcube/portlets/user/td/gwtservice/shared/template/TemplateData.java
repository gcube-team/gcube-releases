...
public class TemplateData implements Serializable {
	...
	public TemplateData(long id, String name, String description, String agency, String category, Contacts owner,
	...
	public String toString() {
		return "TemplateData [id=" + id + ", name=" + name + ", description=" + description + ", agency=" + agency
				+ ", category=" + category + ", owner=" + owner + ", contacts=" + contacts + ", creationDate="
				+ creationDate + "]";
	}
