...
public class GeospatialCreateCoordinatesSession implements Serializable {
	...
	public GeospatialCreateCoordinatesSession(TRId trId, ColumnData latitude, ColumnData longitude,
			GeospatialCoordinatesType type, boolean hasQuadrant, ColumnData quadrant, Double resolution) {
		super();
		this.trId = trId;
	...
	public String toString() {
		return "GeospatialCreateCoordinatesSession [trId=" + trId + ", latitude=" + latitude + ", longitude="
				+ longitude + ", type=" + type + ", hasQuadrant=" + hasQuadrant + ", quadrant=" + quadrant
