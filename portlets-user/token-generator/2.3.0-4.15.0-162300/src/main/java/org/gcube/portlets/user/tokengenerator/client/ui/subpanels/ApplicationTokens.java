...
public class ApplicationTokens extends Composite{
	...
	private static final String messageForUsers = "It is a token associated with an application identifier. All the operations performed with this token " +
			"will be accounted to the specified application and not to your profile. You can require a new token to the VRE Manager by specifying the application's"
			+ " details.";
	...
	private void requireApplicationTokens() {
		...
		tokenServices.isTokenAppVisibile(new AsyncCallback<Boolean>() {

			@Override
			public void onSuccess(Boolean result) {

				if(!result){
					tokenDescription.setText(messageForUsers);
