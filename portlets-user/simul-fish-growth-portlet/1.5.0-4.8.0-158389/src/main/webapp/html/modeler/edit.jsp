...
<form action="<%=addUrl%>" id="<portlet:namespace />fm"
	...
	<fieldset class="fieldset i2s i2s-medium">
		<input type="hidden" name="<portlet:namespace />id" id="<portlet:namespace />id" value="<%=(entity == null ? "0" : entity.getId())%>" />
		<input type="hidden" name="<portlet:namespace />feedQualityId" id="<portlet:namespace />feedQualityId" value="1" />
		<input type="hidden" name="<portlet:namespace />broodstockQualityId" id="<portlet:namespace />broodstockQualityId" value="1" />
		<input type="hidden" name="<portlet:namespace />broodstockGeneticImprovement" id="<portlet:namespace />broodstockGeneticImprovement" value="false" />
