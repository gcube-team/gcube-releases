...
public class ModelerUtil extends ConnectionUtils {
	...
	public void add(Modeler modeler, boolean createSamples) throws Exception {
		URI uri = UriBuilder.fromPath(ConnectionUtils.endpoint).path(ENTITY)
				.queryParam("createSamples", createSamples ? 1 : 0).build();
	...
	public void update(Modeler modeler, boolean createSamples) throws Exception {
