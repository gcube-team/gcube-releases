...
public class WsUtil {
	...
	/**
	 * Gets the workspace used by GWT SERVLET
	 *
	 * @param httpServletRequest the http servlet request
	...
	/**
	 * Gets the workspace, used by external servlets
	 *
	 * @param httpServletRequest the http servlet request
	 ...
	 */
	public static Workspace getWorkspace(HttpServletRequest httpServletRequest, String contextID, String currUserId) throws InternalErrorException, HomeNotFoundException, WorkspaceFolderNotFoundException, SessionExpiredException
	{
...
//		logger.trace("PortalContextInfo: "+info);
		...
		if(currUserId==null || Long.valueOf(currUserId)==-1)
