 ...
 *
 */
public class GWTWorkflowReport extends GWTFolderItem implements IsSerializable {
	
	protected GWTWorkflowReport()
	{}
	
	public GWTWorkflowReport(String id, String name, String description, String owner, Date creationTime, GWTProperties properties, Date lastModificationTime,
	...
	public GWTFolderItemType getFolderItemType() {
		return GWTFolderItemType.WORKFLOW_REPORT;
	}
