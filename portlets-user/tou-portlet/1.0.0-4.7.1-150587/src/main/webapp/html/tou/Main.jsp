...
<div>
	<div style="font-size: 18px">
		...
		carefully. They are available <a href="tou" target="_blank">here</a>.
	</div>
	<br>

	<div class="alert alert-block" id="alertBlock" style="display: none">
		<p style="font-size: 18px">
			<strong>Warning!</strong> Are you sure you want to deny terms of use for this group?
			By doing so you will be removed from this group, thus you will no longer receive updates and lose the
			workspace folder related to the group.
		</p>
