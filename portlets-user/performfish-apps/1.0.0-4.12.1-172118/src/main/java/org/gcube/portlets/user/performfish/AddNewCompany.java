...
/**
 * Portlet implementation class AddNewCompany
 */
public class AddNewCompany extends MVCPortlet {
	...
	public void render(RenderRequest request, RenderResponse response)
		...
		_log.info(" This is render method of AddNewCompany");
		try {
	...
	public void associateCompanies(ActionRequest actionRequest,ActionResponse actionResponse) throws Exception {
		_log.info("associateCompanies action request ...");
		long groupId = ParamUtil.getLong(actionRequest, "groupId");
		Connection conn = DatabaseConnection.getInstance(Utils.getCurrentContext(groupId)).getConnection();
		try {
			String[] companyIdsToAdd = ParamUtil.getParameterValues(actionRequest, "addCompanyIds");
