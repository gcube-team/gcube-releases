 ...
 */
public class ChoiceAnswerModel implements IsSerializable{
	 ...
	 */
	public ChoiceAnswerModel(Integer idSurvey, Integer idUserAnswer, int numberQuestion, String questionType, String choice, String field1,
			String field2) {
