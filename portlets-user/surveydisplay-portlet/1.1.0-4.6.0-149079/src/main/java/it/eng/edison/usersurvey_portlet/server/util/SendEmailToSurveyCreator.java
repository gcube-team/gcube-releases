...
public class SendEmailToSurveyCreator {
	 ...
	 */
	public SendEmailToSurveyCreator(String UrlWithoutParams, String fullNameUser, String emailCreatorManager, String surveyCreator, String currentGroupName, HttpServletRequest request) {
		sendInviteEmail(UrlWithoutParams, fullNameUser, emailCreatorManager, surveyCreator, currentGroupName, request);
	}
	 ...
	 */
	public void sendInviteEmail(String UrlWithoutParams, String fullNameUser, String emailSurveyManager, String surveyManager, String currentGroupName, HttpServletRequest request) throws IllegalArgumentException {

		String emailSubject = null;
		
		if(currentGroupName == null){
			emailSubject = currentGroupName + " member has filled a survey";
		} else {
			emailSubject = currentGroupName + " member has filled a survey on " + currentGroupName;
		}

		EmailNotification mailToSend = new EmailNotification(
				emailSurveyManager , 
				emailSubject, 
				getTextEmail(UrlWithoutParams, fullNameUser, surveyManager, currentGroupName), 
				request);
	 ...
	 */
	private String getTextEmail(String UrlWithoutParams, String fullNameUser, String surveyManager, String currentGroupName) {
		...
		if(currentGroupName == null){
			...
			.append("<br><br>")
			.append(fullNameUser + " has filled a survey.")
			.append("<br>");
		} else {
			body.append("Dear " + surveyManager + ",")
			.append("<br><br>")
			.append(fullNameUser + " has filled a survey in the context of <b>" + currentGroupName + "</b>.")
			.append("<br>");
		}
		
		body.append("To see responses connect to Survey Administration portlet.");
