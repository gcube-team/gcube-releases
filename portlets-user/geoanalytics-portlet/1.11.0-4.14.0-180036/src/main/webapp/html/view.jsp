...
<!-- jstree style -->
	...
	<script src='<c:url value="/js/Utils/notificator.js?01" />'></script>
	...
	<script src='<c:url value="/js/Layers/AutocompletePluginForChooseLayersModal.js?01" />'></script>
...
<div id="blanket">
	...
	<ul class="nav nav-tabs" id="appTabs">
	  <li class="active appTabItem">
	  	<a class="tabLink notClicked" id="project-layer-organization" href="#projectManagement">...</a>
	  </li>
	  <li class="appTabItem disabled">
	  	<a class="tabLink" href="#DSS" data-toggle="tab" id="visualization-tab">...</a>
	  </li>
	</ul>
	...
	<div class="tab-content">
		<div class="tab-pane active" id="projectManagement">
			...
			<div id="projectsHeader">
				...
				<div id="projectsSubheading">select a <span>...</span> or create a new one</div>
			</div>
		...
		<div class="tab-pane" id="DSS">
			...
			<div id="DecisionSupportSystem">
				...
				<div id="dssErrorMessage" align="center" style="color:red;display:none">
								...
								<div id="searchBarCenter" class="row-fluid span12">
									<div id="searchBarCenterElementsContainer"
										...
										<div id="searchBarRadioButtonsContainer" class="span5 row-fluid">
											...
											<div class="span6 ">
												<div id="selectedAreaViewport" class="pickViewport">
													<i class="fa fa-circle-o"></i>
												</div>
												SELECTED AREA <span class="span11 radiobuttonSubheading">Apply to selected area</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div id="collapsibleMenuRightContainer" class="row-fluid">
									<div id="functionsPanel" class="span12">
										...
										<div id="adminSettingsButtonContainer" class="row-fluid span12">
											...
											<div id="gearContainer" class="hidden" style="display:none"></div>
			
											<div id="setting"><i class="fa fa-tasks"></i> Function execution monitoring</div>
				...
				<!-- view more modal  -->
					...
					aria-labelledby="settingsModal" aria-hidden="true" style="display:none">
						...
						<div id="geoanalyitcs-functions-execution-monitoring-container"></div>
	...
	<div id="BBOXModal" class="modal fade wizard" hidden="true" tabindex="-1" role="dialog">
	  <div class="modal-header">
		<div id="blueLineBottom">
		    <span class="modalHeader createHeader">Create a new <span></span></span>
		    <span class="modalHeader editHeader">Edit your <span></span></span>
		    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	    </div>
	  </div>
	  <div class="modal-body">
	  	...
	  	<div id='layerTabsContainer'>
			...
			<div class="tab-content">
				<div class="tab-pane active" id="availableLayers">
					<div class="row-fluid">
						<div id="" class="layers-toolbar span3">
							<input id="searchbar-layers" type="text" placeholder="Search..." class="span12" spellcheck="false">
							<input id="autocomplete-hint-layers-modal" type="text"  disabled="disabled" class="" style="display:none;">
						</div>
						<div class="layers-toolbar">
							<label for="fetchAllAvailableLayers" class="fetchAllAvailableLayersLabelClass">Restrict to selected region</label>
							<input type="checkbox" id="fetchAllAvailableLayers" checked class=""/>
							<label for="fetchAllAvailableLayers"></label>
						</div>
					</div>
	...
	<div id="assignGroupOrIndividualModal" class="modal fade wizard" hidden="true" tabindex="-1" role="dialog">
		...
		<div class="modal-body">
			<div class="modalBodyTitleContainer">
	  		...
	  		<div class="row-fluid">
	  			<div class="span3">
	  				<label for="make-project-public">Public project</label>
	  			</div>
	  			<div class="span9">
	  				<input type="checkbox" id="make-project-public"/>
	  				<label for="make-project-public" id="make-project-public-css-label"></label>
	  			</div>
	  		</div>
		</div>
		<div class="modal-footer">
...
<portlet:resourceURL id="plugin/getLatestExecutionDetailsOf" var="getLatestExecutionDetailsOfURL"/>
...
<script src="<c:url value="/js/jquery_datatables/dataTables.select.min.js?01" />"></script>
...
<!-- Modules Scripts -->
<script defer="defer" src="<c:url value="/js/Modules/config/config.js?01" />"></script>
<script defer="defer" src="<c:url value="/js/Modules/datatable/datatable-widget.js?01" />"></script>
<script defer="defer" src="<c:url value="/js/Modules/functionExecutionMonitor/functionExecutionMonitor.js?01" />"></script>
<%-- <script defer="defer" src="<c:url value="/js/Modules/map/map.js?01" />"></script> --%>

<link rel="stylesheet" href="<c:url value="/js/Modules/datatable/datatable-widget.css?01" />" type="text/css">
...
var createdOrEditedOrDeletedProject = false;
var editModeCallBack;
var previousCoords = {};
...
var drawDSS;
var drawInteractionIsAdded = false;
var drawnGeometryExtent = [];
var clearDDSMapFunction;
var getLatestExecutionDetailsOfURL = '<%=getLatestExecutionDetailsOfURL%>';
...
//	 buildAccordion(RIGHTSIDE_ACCORDION);
	 ...
	 window.config.init({
			...
			resourceURLNoParams : '<portlet:resourceURL id="{url}" />',
			renderURL : renderURL,
