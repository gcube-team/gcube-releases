						...
						<div class="modal-body">
							...
							<div id="modalInfo" class="span6">
								...
								<div id="functionRunAndExportButtons" class="row-fluid btn-group">
									...
									<button id="closeButtonModalBottom" class="span3">
										Close
									</button>
								</div>
		...
		<div class="modalBodyTitleContainer">
	  	...
	  	<div class="selectedUsersSection">
	  		...
	  		<div class="selectdUsersGroupsTagSection hidden">
	  			<input type="text" value="" data-role="tagsinput" hidden="true" class="hidden usersGroupsTagsinput"/>
	  		</div>
	  	</div>
	  </div>
	  <div class="modal-footer">
		...
		<div class="modalBodyTitleContainer">
	  	...
	  	<div class="selectedUsersSection">
	  		...
	  		<div class="assignedUsersTagSection hidden">
	  			<input type="text" value="" data-role="tagsinput" hidden="true" class="hidden assignedUsersTagsinput"/>
	  		</div>
	  	</div>
	  </div>
	  <div class="modal-footer">
