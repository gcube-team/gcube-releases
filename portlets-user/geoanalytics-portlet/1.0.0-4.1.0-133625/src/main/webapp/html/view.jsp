...
<!-- jstree style -->
	...
	<script src="<c:url value="/js/jspdf/jspdf.debug.js?01" />"
		...
		<div class="tab-pane" id="DSS">
			...
			<div id="DecisionSupportSystem">
				...
				<div id="projectAndDate">
					<p id="nameOfProject">No projects available(Create a new project using the Project Management tool)</p>
				...
				<div id="mainScreen">
					<div id="mapCon">
						<div id="mapContainer" class="row-fluid">
							<div id="toolbarNotVisibleInDesktops" class="hidden-desktop-large hidden-phone">
								<div id="toolbarMenuNotVisibleInDesktops" class="hidden-desktop-large">
									<div id="layersResponsive" class="hidden-desktop-large toolbarMenuNotVisibleInDesktopsBtns row-fluid">
										...
										<div class="closeResponsivePane hidden">
										</div>
								...
								<div id="toolbarPaneNotVisibleInDesktops" class="hidden-desktop-large">
									...
									<div id="functionsSelectionResponsivePane" class="hidden-desktop-large  responsivePanes">
										<div id="functionsResponsiveSlider">
											<ul id="functionsResponsiveList">
												<li>
											...
											<div id="sliderRightButton" class="sliderButtons">
												<i class="fa fa-arrow-circle-right"></i>
											</div>
											<div id="sliderLeftButton" class="sliderButtons">
							...
							<div id="collapsibleMenuRight" class="shown visible-desktop">
								<div id="collapsibleMenuRightContainer" class="row-fluid">
									<div id="functionsPanel" class="span12">
										...
										<div class="functionsAccordion">
										</div>
			
			
										<div id="adminSettingsButtonContainer" class="row-fluid span12 hidden">
								...
								<div id="overlayForSingleClickingOnMap" class="">
									<div id="popoverTitleContainer" class="">
										...
										<div id="popoverBodyContainingInfo" class="row-fluid">
											...
											<!-- <div class="row-fluid popoverInfoRow">
												<div class="popoverInfoRowLabel span6"> </div>
												<div class="popoverInfoRowData span5"> </div>
											</div>
											<div class="row-fluid popoverInfoRow">
												<div class="popoverInfoRowLabel span6"></div>
				...
				<!-- view more modal  -->
					...
					aria-labelledby="settingsModal" aria-hidden="true" style="display:none">
									...
									<div id="coordsOnModalContainer" class="span11">
										<div id="coordsOnModalTitleContainer" class="span10">
											<div id="coordsOnModalTitle" class="">37° 09′ 53″ N 21° 21′
												46″ E</div>
											<div id="regionInPathFormInModal" class="">LOREM / IPSUM /
												DOLOR / SIT / AMET</div>
										</div>
									</div>
								</div>
							...
							<div id="modalInfo" class="span6">
								<div id="modalAttributesContainer">
									<div class="row-fluid modalInfoRow">
										<div class="modalInfoRowLabel span6">Lorem ipsum dolor :</div>
										<div class="modalInfoRowData span5">Lorem ipsum dolor</div>
									</div>
									<div class="row-fluid modalInfoRow">
										<div class="modalInfoRowLabel span6">Lorem ipsum dolor :</div>
										<div class="modalInfoRowData span5">Lorem ipsum dolor</div>
								...
								<div id="functionRunAndExportButtons" class="row-fluid btn-group">
									<!-- <div id="exportAsButtonModalBottom" class="span4 offset5 dropdown">
										<a class="dropdown-toggle" role="button" data-toggle="dropdown" href="#" id="dropMenu">
											Export as<i class="fa fa-caret-down"></i>
										</a>
										<ul class="dropdown-menu" role="menu" aria-labelledby="dropMenu">
											<li role="presentation">
												<a role="menuitem" tabindex="-1" href="#" id="exportAsPNG" download="map.png">
													<i class="fa fa-download" aria-hidden="true"></i>&nbsp;PNG
												</a>
											</li>
											<li role="presentation">
												<a role="menuitem" tabindex="-1" href="#" id="exportAsJPEG" download="map.jpg">
													<i class="fa fa-download" aria-hidden="true"></i>&nbsp;JPEG
												</a>
											</li>
											<li role="presentation">
												<a role="menuitem" tabindex="-1" href="#" id="exportAsPDF" download="map.pdf">
													<i class="fa fa-print" aria-hidden="true"></i>&nbsp;PDF
												</a>
											</li>
										</ul>
									</div> -->
									<button id="closeButtonModalBottom" class="span3 offset8">
										Close
									</button>
								</div>
						...
						<!-- Settings Modal -->
					<div id="settingModal" class="modal fade in" tabindex="-1" role="dialog"
						aria-labelledby="settingsModal" aria-hidden="true" style="display:none">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
							<h5 id="modalLabel">Setting</h5>
						</div>
						<div class="modal-body">
							<form>
								<div class="form-group">
									<label class="pickLayerTemplateLabel" for="pickLayerTemplate">Pick
										layer template</label>
									<div class="selector-wrapper">
										<select class="form-control layer-selector pickLayerTemplate" name="layer-selector" id="layerSelector">
								...
								<div>
									<div class="form-group">
										<label class="nameOfNewLayerLabel" for="nameOfNewLayer">Name of new layer</label>
						      			<input type="text" id="nameOfNewLayer" class="form-control nameOfNewLayer">
					      			</div>
								</div>
								<div class="form-group tsvDiv">
									<input id="TSVFileName" type="text">
									<div id="importTSVButton">
										<i class="icon-cloud-upload"></i> 
										Upload TSV
									</div>
									<label class="importTsv"> 
										<input class="importTsv" type="file" /> 
									</label>
								</div>
								<button class="btn" data-dismiss="modal" aria-hidden="true">cancel</button>
								<button class="btn" type="submit" disabled>Import</button>
							</form>
						</div>
					</div>
	...
	<div id="projectViewModal" class="modal fade" hidden="true" tabindex="-1" role="dialog">
	  ...
	  <div class="modal-body">
	  	...
	  	<div class="row-fluid">
	  		...
	  		<div id="viewModalProjectParticipants" class="viewModalProjectAttributes"></div>	
	  	</div>
	  	
	  	<div class="row-fluid">
	  		<div class="span4 viewDetailsLabels">Layers:</div>
			<div id="viewModalProjectLayerNames" class="viewModalProjectAttributes"></div>	
	  	</div>
	  </div>
...
<div id="onDeleteSure" class="modal fade in" tabindex="-1" role="dialog" aria-hidden="true" style="display:none">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h5 id="modalLabel">Project deletion</h5>
	</div>
	<div class="modal-body">
...
var coordsDSSTab;
		...
		var layersNamesTest = [];
		layersNamesTest.push('Function1');
...
//	DSS
	var calculateSample = '<%= calculateSample %>'; 
	 //$('#DecisionSupportSystem').contents().last().remove();
	 $('#importTSVButton').off().on('click', function(){
		 $('input.importTsv').click();
	 });
	 leftSidePanelHandlersAndEvents();
	 rightSidePanelHandlersAndEvents();
	 searchBar();
	 mapInit();
	 /* settingUpSettings(listLayersByTaxonomyID, importTsv);
	 settingUpModel(listLayersByTaxonomyID, calculateSample); */
	 mapExportEvents();
	 showMoreLessText();
	 exportMap();
