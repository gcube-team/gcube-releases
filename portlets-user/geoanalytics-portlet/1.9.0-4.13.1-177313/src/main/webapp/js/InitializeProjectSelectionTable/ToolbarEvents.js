function toolbarEvents($publicProjectsButton) {
//	Increase width of search input
	$('#ProjectSelectionTable_filter label input').addClass('input-xlarge');
	$('#ProjectSelectionTable_filter label').css('display','inline-block');
	$('#ProjectSelectionTable_filter').prepend($publicProjectsButton);
...
//	Add behavior to each individual button on click
	$('#alphabOrder').on('click', function() {
		if($(this).hasClass('sortAsc')){
			...
			$('#ProjectSelectionTable_filter input[type=search]').val(searchVal);
