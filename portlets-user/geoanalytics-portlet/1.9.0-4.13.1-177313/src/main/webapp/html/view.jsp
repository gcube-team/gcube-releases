							...
							<div id="map" class="">
								...
								<div id="coord-info" class="span12">
									<div id='coord-info-con' class="row-fluid">
										<div id="coord-long-section" class="span2">
											<span>Long:</span>
										</div>
										<div id="coord-lat-section" class="span2">
											<span>Lat: </span>
										</div>
										<div id="eye-section" class="span3 eye-section">
											<span>Eye: </span>
										</div>
										<div id="legend" class="span3" >
							...
							<div id="collapsibleMenuRight" class="shown">
								...
								<div id="collapsibleMenuRightContainer" class="row-fluid">
									<div id="functionsPanel" class="span12">
											...
											<div id="functionsContainer" class="functionsAccordion new">
