...
public class GeoExplorerParameters {
	...
	private List<String> layerUUIDs = null; //init the GeoExplorer grid using UUIDs passed into list
	...
	/**
	 * @return the layerUUIDs
	 */
	public List<String> getLayerUUIDs() {
	...
	/**
	 * @param layerUUIDs the layerUUIDs to set
	 */
	public void setLayerUUIDs(List<String> layerUUIDs) {
