...
public class ManageSurveyView extends Composite {
    ...
    List<CreateQuestionView> listSurveyQuestion = null;
	...
	private void AddQuestionSurvey() {
		...
		//new box question
		createSurveyView = new CreateQuestionView(getIdSurveyTemp());
	...
	private void addSurvey2List() {
		...
		for (int i=0;i<questionSurveyList.size();i++){
			currQuestion  = (CreateQuestionView) questionSurveyList.get(i);
			/* Text Question */
			if(currQuestion.getTypeSurvey().getValue().equals("Text")){
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getAnswerTextBox().getValue(), currQuestion.getFilenameImage(), getIdTmpFolder(), currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
				/* Paragraph Text Question */
			} else if(currQuestion.getTypeSurvey().getValue().equals("Paragraph Text")){
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getAnswerTextArea().getValue(), currQuestion.getFilenameImage(), idTmpFolder, currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
				...
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getMultipleChoiceList(), currQuestion.getFilenameImage(), idTmpFolder, currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
				/* Grid Question */ 
			} else if (currQuestion.getTypeSurvey().getValue().equals("Grid")){
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getRowGridList(), currQuestion.getColumnGridList(), currQuestion.getFilenameImage(), idTmpFolder, currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
				
			} else if (currQuestion.getTypeSurvey().getValue().equals("Date")){
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getDateAnswerSurvey().getValue(), currQuestion.getFilenameImage(), idTmpFolder, currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
				/* Time Question */
			}else if (currQuestion.getTypeSurvey().getValue().equals("Time")){
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getTimeHourAnswerSurvey().getValue(), currQuestion.getTimeMinuteAnswerSurvey().getValue(), currQuestion.getFilenameImage(), idTmpFolder, currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
				/* Scale Question */
			}else if (currQuestion.getTypeSurvey().getValue().equals("Scale")){
				addQuestionToSurveyList(getIdSurvey(), currQuestion.getIdQuestion(), currQuestion.getCheckBoxMandatory().getValue(), currQuestion.getTypeSurvey().getValue(), currQuestion.getQuestionSurveyTextArea().getValue(), currQuestion.getScaleFromSurveyListBox().getValue(), currQuestion.getScaleToSurveyListBox().getValue(), currQuestion.getScaleFromSurveyTextBox().getValue(), currQuestion.getScaleToSurveyTextBox().getValue(), currQuestion.getFilenameImage(), idTmpFolder, currQuestion.sectionTitle.getText(), currQuestion.sectionDescription.getText());
			}
	 ...
	 */
	public void setListSurveyQuestion(List<CreateQuestionView> listSurveyQuestion) {
