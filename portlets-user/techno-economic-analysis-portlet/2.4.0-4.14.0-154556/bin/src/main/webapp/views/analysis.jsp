...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/dialogs.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/workspace.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/workspace-context-menu.css" />	
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/responsive.css" />		
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/util-classes.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/noty.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/components/analysis.css" />		
...
<script src='<%=request.getContextPath()%>/js/components/noty.js'></script>
<script src='<%=request.getContextPath()%>/js/components/ajax.js'></script>

<script defer="defer" src="<%=request.getContextPath()%>/js/components/dom.js"></script>
<script defer="defer" src='<%=request.getContextPath()%>/js/components/validation.js'></script>	
<script defer="defer" src="<%=request.getContextPath()%>/js/components/analysis.js"></script>
<script defer="defer" src="<%=request.getContextPath()%>/js/components/dialogs.js"></script>
<script defer="defer" src="<%=request.getContextPath()%>/js/components/workspace.js"></script>

<%-- <script defer="defer" src="<%=request.getContextPath()%>/js/components/global.js"></script>
	...
	<form class="custom-container" id="analysisForm" >
		...
		<div id="tea-results-container">
			...
			<div id="tea-info-container" align="center">
				...
				<button class="btn load-analysis"><i class="fa fa-fw fa-folder-open" aria-hidden="true"></i>Load analysis from Workspace</button>
			</div>
