...
public class DatabaseDiscovery {
	...
	public static DatabaseCredentials fetchDatabaseCredentials(String scope, DatabaseProfile databaseProfile) throws DatabaseDiscoveryException {			
		...
		try{
			...
			databaseCredentials = databaseCredentialsList.get(0);	
			...
			throw new DatabaseDiscoveryException("Failed to discover any " + "/" + databaseProfile.getName() + " endpoint for scope " + scope, e);
		}
