...
<div class="techno-economic-analysis-portlet">
	  ...
	  <div class="row-fluid">
	  		<div class="span3">
				  <form class="form-horizontal">
						<div class="control-group">
						  <label class="control-label" for="tea_production_model">Production model</label>
							<div class="controls">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" id="tea_tax_rate" value="29"  step="0.1">
							</div>
						</div>
						<div class="control-group">
							<!-- <label class="control-label" for="tea_fish_mix">Mix (%)</label> -->
							<div class="controls">
								<input type="hidden" class="form-control" id="tea_fish_mix" value="100" step="0.1">
							</div>
						</div>						
					</form>
		</div>
		...
		<form class="form-horizontal">
			 <div class="control-group">
				...
				<div class="controls">
					<input class="span4" type="number" id="tea_fish_feed_price" value="1.25" step="0.01">	
					<select class="tea_currency span2" disabled>
			  ...
			  <div class="control-group">
				...
				<div class="controls">
					<input class="span4" type="number" id="tea_fish_fry_price" value="0.20" step="0.01">
					<select class="tea_currency span2" disabled>
						<option selected="selected">&euro;</option>
						<option>$</option>
					</select>	
		...
		<div class="span4">
			...
			<div class="control-group">
			 ...
			 <div class="control-group">
				...
				<div class="controls">
					<input class="span4" type="number" id="tea_fish_selling_price" value="4.80" step="0.01">
					<select class="tea_currency span2" disabled>
						<option selected="selected">&euro;</option>
						<option>$</option>
					</select>	
	...
	<div class="row-fluid">
		<div class="tea_help_text">*The analysis is based on aqua farms of annual fish production of 1000 tons</div>
	</div>
	...
	<div id="tea_results_container">
		...
		<p 	id="tea_insert_text"
			style="	font-style:italic;
					text-align: center;
					color: gray;"> 
			Insert parameters and perform estimation analysis 
		</p>
