...
public class WorkspaceController {	
	...
	public void getFolders(ResourceRequest request, ResourceResponse response,
	...
	public void createFolder(ResourceRequest request, ResourceResponse response,
							 ...
							 @RequestParam("destinationFolderId") 	String destinationFolderId) {		
		try {				
	...
	public void removeFile(ResourceRequest request, ResourceResponse response,
	...
	public void renameFile(ResourceRequest request, ResourceResponse response,
							@RequestParam("fileId") String fileId,
	...
	public void saveAnalysis(ResourceRequest  request, ResourceResponse response,
							 @RequestParam("analysis")  			String analysis,
							 @RequestParam("analysisName")  		String analysisName,
							 @RequestParam("analysisDescription")  	String analysisDescription,
							 @RequestParam("destinationFolderId")  	String destinationFolderId) {
	...
	public void loadAnalysis(ResourceRequest request, ResourceResponse response,
	...
	public void getInfo(ResourceRequest request, ResourceResponse response,
			   				  @RequestParam("fileId") String fileId) {
