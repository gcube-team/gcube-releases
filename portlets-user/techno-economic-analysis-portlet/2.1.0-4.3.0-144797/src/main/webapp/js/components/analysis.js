 ...
 (function() {
	...
	var analytics = {
		...
		init : function(config) {
			...
			$(".techno-economic-analysis-portlet input[type='number']," +
			  "#tea_production_model, #tea_is_off_shore_aqua_farm").change(function(){
					$("#tea-reset-button").show();					
			});
		...
		showParameters: function(data){
			...
			console.log("data fishspecies = " + data.fishSpecies);
			...
			$('#tea_inflation_rate').val(inflationRate["2018"]),
