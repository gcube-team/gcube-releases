...
/**
 * Class: OpenLayers.Handler.Line
 * Handler to draw a Line on the map.  Line is displayed on mouse down,
 * moves on mouse move, and is finished on mouse up.
 *
 * Inherits from:
 *  - <OpenLayers.Handler.Point>
 */
OpenLayers.Handler.Line = OpenLayers.Class(OpenLayers.Handler.Point, {
    ...
    /**
     * Constructor: OpenLayers.Handler.Line
     * Create a new Line hander
     *
     * Parameters:
