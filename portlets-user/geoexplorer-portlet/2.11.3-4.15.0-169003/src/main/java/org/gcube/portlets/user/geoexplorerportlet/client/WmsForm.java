...
public abstract class WmsForm extends Composite {
	...
	private static final int INPUT_WIDTH_OFFSET = 220;
	...
	public WmsForm() {
		...
		form_wms_add_layer.setWidth(width+"px");
//		setSize(width+"px", "200px");
		input_layer_name.setWidth(width-INPUT_WIDTH_OFFSET+"px");
		input_layer_title.setWidth(width-220+"px");
		input_WMS_URI.setWidth(width-220+"px");
...
//		alertSubmitResult.addStyleName("marginTop10");
		...
		vp_form_actions.setCellHorizontalAlignment(close_dialog, HasHorizontalAlignment.ALIGN_RIGHT);
		//hp_form_actions.a
