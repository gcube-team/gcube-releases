...
public class Assertionsvalidation implements IAssertionValidator 
{
	...
	/* (non-Javadoc)
	 * @see eu.vision.ips.asserts.validate.IAssertionValidator#configure(eu.vision.ips.asserts.configuration.ConfigurationBean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.vision.ips.asserts.validate.IAssertionValidator#validateAssertions(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.vision.ips.asserts.validate.IAssertionValidator#getAssertionObject(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.vision.ips.asserts.validate.IAssertionValidator#validateTimeInterval(org.opensaml.saml2.core.Assertion)
	 */
	@Override
	public boolean validateTimeInterval (Assertion assertion)
	{
		String confValue = this.configuration.getProperty(ConfigurationBean.TIME_VALIDATION_ENABLED);
	...
	/* (non-Javadoc)
	 * @see eu.vision.ips.asserts.validate.IAssertionValidator#validateSignature(org.opensaml.saml2.core.Assertion)
	 */
	@Override
