...
public interface PrincipalDao extends Dao<Principal, UUID> {
	...
	public List<Principal> findByClassAndCreatorName(PrincipalClass classType, ActiveStatus activeStatus, String tenant, Principal principal);
	...
	public List<PrincipalProjectInfoDao> findByClassReturnsPrincipalProjectInfo(PrincipalClass classType,
			ActiveStatus activeStatus, String tenant);
