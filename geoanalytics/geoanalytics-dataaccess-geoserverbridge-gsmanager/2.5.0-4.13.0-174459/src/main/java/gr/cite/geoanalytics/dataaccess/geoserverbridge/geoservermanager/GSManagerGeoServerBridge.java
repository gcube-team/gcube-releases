...
public class GSManagerGeoServerBridge implements GeoServerBridge {
	...
	{
		System.out.println("im in add style and geoserver Url is:"+geoServerBridgeConfig.getGeoServerBridgeUrl());
		System.out.println("im in add style and geoserver user is:"+geoServerBridgeConfig.getGeoServerBridgeUser());
