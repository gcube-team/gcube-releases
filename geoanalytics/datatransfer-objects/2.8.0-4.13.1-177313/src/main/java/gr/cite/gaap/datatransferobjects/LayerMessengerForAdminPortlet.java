...
public class LayerMessengerForAdminPortlet {
	...
	public boolean isPublishedOnGeoNetwork() {
		return publishedOnGeoNetwork;
	}

	public void setPublishedOnGeoNetwork(boolean publishedOnGeoNetwork) {
		this.publishedOnGeoNetwork = publishedOnGeoNetwork;
	}
	...
	public void setIsCached(String isCashed) {
		this.isCached = isCashed;
	}
}
