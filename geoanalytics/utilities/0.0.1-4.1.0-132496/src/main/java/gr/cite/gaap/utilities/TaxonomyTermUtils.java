...
public class TaxonomyTermUtils 
{
	...
	public static String storeLocalizedValue(TaxonomyTerm tt, String locale, String value) throws Exception
	{
		synchronized(dbLock)
		{
			if(db == null)
	...
	public static String storeLocalizedValue(TaxonomyTerm tt, String locale, String value, DocumentBuilder db) throws Exception
	{
	...
	public static String retrieveLocalizedValue(TaxonomyTerm tt, String locale) throws Exception
	{
		if(tt.getExtraData() == null || tt.getExtraData().isEmpty())
			return null;
		...
		return retrieveLocalizedValue(tt, locale, db);
	}
	
	public static String retrieveLocalizedValue(TaxonomyTerm tt, String locale, DocumentBuilder db) throws Exception
	{
		if(tt.getExtraData() == null || tt.getExtraData().isEmpty())
			return null;
	...
	public static boolean isUserCreated(TaxonomyTerm tt) throws Exception
	{
		if(tt.getExtraData() == null || tt.getExtraData().isEmpty())
			return false;
	...
	public static boolean isUserCreated(TaxonomyTerm tt, DocumentBuilder db) throws Exception
	{
		if(tt.getExtraData() == null || tt.getExtraData().isEmpty())
			return false;
		Document d = parseDocument(tt.getExtraData(), db);
	...
	public static String getUserCreatedTermValue(TaxonomyTerm tt) throws Exception
	{
		if(tt.getExtraData() == null || tt.getExtraData().isEmpty())
			return null;
	...
	public static String getUserCreatedTermValue(TaxonomyTerm tt, DocumentBuilder db) throws Exception
	{
		if(tt.getExtraData() == null || tt.getExtraData().isEmpty())
			return null;
