...
public class GeospatialBackendClustered {
	...
	@Transactional
	public void createCoverageOfLayer(GosDefinition gosDefinition, Coverage coverage, InputStream geotiff) throws Exception {
		dataCreatorGeoanalytics.addLayer(coverage.getLayerID().toString(), ZNodeStatus.ACTIVE, gosDefinition.getGosIdentifier());
		System.out.println("I inserted "+coverage.getLayerID().toString() + "to zookeeper");
//		rasterManagement.createCoverage(gosDefinition.getGosEndpoint(), coverage, geotiff);
	}
