...
public class TotalBmSeaBreamFunction implements Function, Serializable {
	...
	public TotalBmSeaBreamFunction(String tenant, Map<String, String> credentials) throws Exception {
		this.tenant = tenant;
