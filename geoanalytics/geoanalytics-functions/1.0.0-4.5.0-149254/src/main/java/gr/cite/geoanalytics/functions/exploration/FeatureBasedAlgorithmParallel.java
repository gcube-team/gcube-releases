...
@Configurable
public class FeatureBasedAlgorithmParallel implements Serializable{
	...
	public String execute(
			...
			String creatorID,
			int scanStepMeters,
			String paraktiesLayerID, 
			String citiesLayerID, 
			String natura2000LayerID,
			String sst,
			String crsCode,
...
//					new NPVFunction(sst);
		...
		return geoanalyticsStore.storeToGeoanalytics(layerName, tenantID, creatorID, gosDefinition, simpleFeaturesListRDD, crsCode);
