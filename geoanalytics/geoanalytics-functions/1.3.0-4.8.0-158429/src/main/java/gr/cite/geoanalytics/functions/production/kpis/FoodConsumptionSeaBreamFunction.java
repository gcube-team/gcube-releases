...
public class FoodConsumptionSeaBreamFunction implements Function, Serializable {
	...
	public FoodConsumptionSeaBreamFunction(String tenant, Map<String, String> credentials) throws Exception {
		this.tenant = tenant;
