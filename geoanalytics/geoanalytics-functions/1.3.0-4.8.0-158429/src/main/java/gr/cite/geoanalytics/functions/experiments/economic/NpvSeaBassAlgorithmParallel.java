...
public class NpvSeaBassAlgorithmParallel implements AquacultureAlgorithm, Serializable {

	private static final long serialVersionUID = 3033238757748897716L;

	private static final Logger logger = LoggerFactory.getLogger(NpvSeaBassAlgorithmParallel.class);
	...
	public NpvSeaBassAlgorithmParallel(int hPartitions, int vPartitions) {
	...
	public void execute(String execID, JavaSparkContext sparkContext, String layerName, String styleName, String projectID, String tenantName, String tenantID, String creatorID,
		...
		JavaRDD<List<ShapeMessenger>> simpleFeaturesListRDD = partitions.map(s -> {
			...
			Function function = new NpvSeaBassFunction(tenantName, credentials);
