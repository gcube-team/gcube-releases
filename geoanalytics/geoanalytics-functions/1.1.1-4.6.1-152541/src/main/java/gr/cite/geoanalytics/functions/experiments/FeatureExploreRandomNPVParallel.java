	...
	//		String tenantName = executionParameters.getTenantName();
			...
			new Thread(){
				...
				//				  .set("spark.driver.memory", "4g") 
						...
						featureBasedAlgorithmParallel.execute(executionID, sparkContext, layerName, projectID, tenantName, tenantID, creatorID, DISTANCE_METERS, executionParameters.getFunctionLayerConfig(), sst, FEATURE_TYPE_CRS, minimumX, minimumY, maximumX, maximumY);
						sparkContext.stop();
					}
					catch(Exception ex){
						ex.printStackTrace();
