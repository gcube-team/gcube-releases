...
public class TestOxygenRetriever {
	...
	private static OxygenRetriever oxygenRetriever = new OxygenRetriever();
	...
	public void testGetByDateLatLong() {
		...
		try {
			Oxygen oxygen = oxygenRetriever.getByDateLatLong("31-12-2016", latitude, longitude);
	...
	public void test() {
		...
		try {
			oxygenRetriever.getByDateLatLong("1/1/2016", latitude, longitude);
			oxygenRetriever.getByDateLatLong("29/2/2016", latitude, longitude);
			oxygenRetriever.getByDateLatLong("31/5/2022", latitude, longitude);
			oxygenRetriever.getByDateLatLong("30/12/2035", latitude, longitude);
			oxygenRetriever.getByDateLatLong("16/4/1998", latitude, longitude);
		} catch (Exception e) {
			logger.error(e);
		}
	}
