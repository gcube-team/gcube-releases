...
public class HttpClientTest {
	...
	public void testFindTermMappingsForLayerShapes() throws Exception {
		TaxonomyTerm layerTerm = taxonomyManager.findTermByNameAndTaxonomy("Taxon1Term1", "Taxon1", false);
		Set<TaxonomyTermShape> cTts = new HashSet<>(clusteredGeospatialBackend.findTermMappingsOfLayerShapes(layerTerm));
		Set<TaxonomyTermShape> lTts = new HashSet<>(shapeManager.findTermMappingsOfLayerShapes(layerTerm));
