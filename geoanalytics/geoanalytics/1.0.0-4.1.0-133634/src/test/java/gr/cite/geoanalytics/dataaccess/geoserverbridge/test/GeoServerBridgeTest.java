...
public class GeoServerBridgeTest
{
	...
	{
		List<Layer> layers = geoServerBridge.getLayers();
		for(Layer l : layers)
		{
			System.out.println("Layer: " + l.getWorkspace() + ":" + l.getDatastore() + ":" + l.getName() + "--" +
	...
	public void importLayer(String filename) throws Exception
	{
		...
		vb.forShape(s).createViewStatement().execute();
		...
		l.setName(s.getName());
		l.setType("VECTOR");
		geoServerBridge.addLayer(l, ft, new HashMap<String, String>());
	...
	public void test() throws Exception {
		...
		Layer layer = geoServerBridge.getLayer("sadasdasdasdsadasdasdsa");
