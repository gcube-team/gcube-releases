...
public class PluginController extends BaseController {
	...
	@RequestMapping(value={"/plugin/fetchPluginsByPluginLibraryId"}, method=RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
	...
	@RequestMapping(value={"/plugin/fetchConfiguration"}, method=RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
	...
	@RequestMapping(value={"/plugin/executionDetails"}, method=RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
	...
	@RequestMapping(value={"/plugin/executeFunction"}, method=RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
...
//			return new GenericResponse(Status.Success, result, "Authorized");
	...
	@RequestMapping(value = "/plugin/loadPluginByNameAndTenant", method = RequestMethod.GET, produces = { "application/json" })
...
//			widget = new File("/tmp/geoanalytics_plugins/shared/7779d1cc-1201-4848-841b-d2e6d8cf9705/7779d1cc-1201-4848-841b-d2e6d8cf9705.jar");
	...
	@RequestMapping(value = { "/plugin/upload" }, method = RequestMethod.POST, consumes = { "multipart/form-data" }, produces = { "application/json" })
...
//			pluginManager.validateFile(request);
	...
	@RequestMapping(value={"/plugin/listPluginsByTenantOrNullTenant"}, method=RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
...
//			return new GenericResponse(Status.Failure, false, e.getMessage());
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/plugin/deletePluginAndPluginLibrary"}, consumes="application/json", produces = { "application/json" })
	...
	@RequestMapping(value = { "/plugin/updatePlugin" }, method = RequestMethod.POST, consumes="application/json", produces = { "application/json" })
	...
	@RequestMapping(value={"/plugin/executionStatus"}, method=RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
	...
	@RequestMapping(value = {"/plugin/getLatestExecutionDetailsOf"}, method = RequestMethod.GET, produces = { "application/json" })
	...
	@RequestMapping( value = "/plugin/deleteExecutionDetailsInfo", method = RequestMethod.POST, consumes={"application/json"}, produces = { "application/json" })
