...
public class ShapeController {
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/admin/shapes/retrieveShape"}, consumes="application/json", produces = {"application/json"})
...
//		}
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/shapes/retrieveByTerm"}, consumes="application/json", produces = {"application/json"})
...
//		sm.setName(s.getName());
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/shapes/searchFast"}, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/admin/shapes/search"}, consumes="application/json", produces = {"application/json"})
...
//	}
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/admin/shapes/update"}, consumes="application/json", produces = {"application/json"})
...
//			s.setName(HtmlUtils.htmlEscape(sm.getName().trim()));
	...
	@RequestMapping(method = RequestMethod.POST, value = {"/admin/shapes/delete"}, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value= "/shapes/mostSpecificBreadcrumbsByCoordinates" , method=RequestMethod.POST, consumes={"application/json"}, produces = {"application/json"})
	...
	@RequestMapping(value= "/shapes/breadcrumbsByCoordinates" , method=RequestMethod.POST, consumes={"application/json"}, produces = {"application/json"})
