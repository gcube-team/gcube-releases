...
//	}
//
//	@RequestMapping(value = "/resend_password", method=RequestMethod.POST,  produces = {"application/json"})
...
//	}
	...
	@RequestMapping(value = "/projects/listClients", method = RequestMethod.POST,  produces = {"application/json"})
...
//	};
	...
	@RequestMapping(value="/documents/retrievet", method=RequestMethod.POST, consumes="application/json",  produces = {"application/json"})
...
//	};
	...
	@RequestMapping(value="/documents/attributeDocuments", method = RequestMethod.POST, consumes="application/json",  produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/list"}, method=RequestMethod.POST,  produces = {"application/json"})
	@Secured("ROLE_admin")
	...
	@RequestMapping(value={"/projects/bbox2"}, method=RequestMethod.POST, consumes={"application/json"}, produces = "application/json")
...
//			auditAction("retrieveSummary", null, "Project", principal);
	...
	@RequestMapping(value={"/projects/authorizedToRead"}, method=RequestMethod.POST, consumes={"application/json"}, produces = "application/json")
	...
	@RequestMapping(value={"/projects/authorizedToEdit"}, method=RequestMethod.POST, consumes={"application/json"}, produces = "application/json")
	...
	@RequestMapping(value={"/projects/authorizedToDelete"}, method=RequestMethod.POST, consumes={"application/json"}, produces = "application/json")
...
//	}
	...
	@RequestMapping(value={"/projects/brief"}, method=RequestMethod.POST, consumes={"application/json"}, produces = "application/json")
	public @ResponseBody GenericResponse retrieveProjectInBrief(@RequestBody boolean showPublicProjects) {
		...
		try {
			...
			Set<Project> projects = projectManager.fetchProjectsForPrincipal().stream().filter(prj -> prj.isPublic() == false).collect(Collectors.toSet());//stream().filter(prj -> prj.isPublic() == showPublicProjects).
			if(showPublicProjects) {
				Set<Project> publicProjects = projectManager.allProjects().stream().filter(prj -> prj.isPublic() == showPublicProjects && prj.getTenant().getId().equals(securityContextAccessor.getTenant().getId())).collect(Collectors.toSet());
	...
	@RequestMapping(value={"/projects/viewDetails"}, method=RequestMethod.POST, consumes={"application/json"},  produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/participants"}, method=RequestMethod.POST, consumes={"application/json"},  produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/retrieve"}, method=RequestMethod.POST, consumes="application/json",  produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/add"}, method=RequestMethod.POST, consumes="application/json",  produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/assignUsersToProjectGroup"}, method=RequestMethod.POST, consumes="application/json",  produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/updateProject"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/update"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/remove"}, method=RequestMethod.POST, consumes="application/json",produces="application/json")
	...
	@RequestMapping(value={"/projects/delete"}, method=RequestMethod.POST, consumes="application/json", produces="application/json")
	...
	@RequestMapping(value={"/projects/retrieveInfo"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/updateInfo"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/addAttribute"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/removeAttribute"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/commonUserAttributes"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/retrieveTasks"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/addTask"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/updateTask"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/removeTask"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/retrieveDocuments"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/addProjectDocument"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/removeProjectDocument"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/retrieveTaskDocuments"}, method=RequestMethod.POST, consumes="application/json", produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/retrieveDocumentTasks"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/addTaskDocument"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/projects/removeTaskDocument"}, method=RequestMethod.POST, produces = {"application/json"})
	...
	@RequestMapping(value={"/shapes/geoLocate"}, method=RequestMethod.POST, produces = {"application/json"})
...
//	}
	...
	@RequestMapping(value = "/geography/terms", method = RequestMethod.POST,  produces = {"application/json"})
	...
	@RequestMapping(value = "/geography/children", method = RequestMethod.POST, produces = {"application/json"})
