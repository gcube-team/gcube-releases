...
public class GeoanalyticsPortalPreAuthenticationFilter extends AbstractPreAuthenticatedProcessingFilter
{
	...
	protected Object getPreAuthenticatedPrincipal(HttpServletRequest request) {
		log.debug("************** User attempting to connect *******************");
		...
		log.debug("Username: " + principalName);
		log.debug("Email: " + principalEmail);
		log.debug("VreUsrID: " + userId);
		log.debug("Tenant: " + tenantName);

//		System.out.println("Username: " + principalName);
//		System.out.println("Email: " + principalEmail);
//		System.out.println("initials:"+principalInitials);
//		System.out.println("VreUsrID: " + userId);
//		System.out.println("Tenant: " + tenantName);
		...
		log.debug("User provided all required info. Continuing ..........");
