...
public class AdminController  {
	...
	@Autowired private ImportManager layerMan;
	...
	@RequestMapping(value = "/users/listUsers", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/tags/createTag", method = RequestMethod.POST, consumes={"application/json"})
	...
	@RequestMapping(value = "/admin/tags/deleteTag", method = RequestMethod.POST, consumes={"application/json"})
	...
	@RequestMapping(value = "/admin/tags/editTag", method = RequestMethod.POST, consumes={"application/json"})
	...
	public @ResponseBody List<TaxonomyTermLinkMessenger> retrieveTaxonomyTermLinks(String taxonomy) throws Exception {
		GeocodeSystem t = taxonomyMan.findGeocodeSystemByName(taxonomy, false);
		if (t == null)
			throw new Exception("Taxonomy " + taxonomy + " does not exist");

		List<TaxonomyTermLink> ttls = taxonomyMan.getTermLinksOfGeocodeSystem(t.getId().toString(), true, true);
	...
	public @ResponseBody UpdateResponse updateLayerStyle(@RequestBody LayerStyleMessenger layerStyle) throws Exception {
		try {
			...
			Layer layer = layerManager.findLayerById(UUID.fromString(layerStyle.getTermId()));
			
			if (layer == null)
				return new UpdateResponse(false, "Term not found");

			
			layerMan.configureLayer(layer, layerStyle.getTheme(), layerStyle.getStyle(), layerStyle.getMinScale(),
