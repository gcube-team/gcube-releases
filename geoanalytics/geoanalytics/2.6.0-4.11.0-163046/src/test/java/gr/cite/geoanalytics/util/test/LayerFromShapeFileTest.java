...
//	}
	...
	public String importLayer(String filename, int srid, String charset, boolean axisInvert) throws Exception
	{
		...
		featureType.setDatastore(GosConfiguration.getGeoServerBridgeDataStore());
		featureType.setWorkspace(GosConfiguration.getGeoServerBridgeWorkspace());
		...
		Layer l = new Layer();
		l.setWorkspace(GosConfiguration.getGeoServerBridgeWorkspace());
		l.setDatastore(GosConfiguration.getGeoServerBridgeDataStore());
		l.setEnabled(true);
