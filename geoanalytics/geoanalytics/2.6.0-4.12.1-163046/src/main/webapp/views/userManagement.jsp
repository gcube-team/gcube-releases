					...
					<div class="form-group">
						<label for="addFormTextBoxrights" class="addFormElement col-md-2 control-label">Rights</label>
							<div class="addFormElement col-md-10">
								<textarea rows="2" id="addFormTextBoxrights" class="addFormElement form-control" name="rights">
								</textarea>
							</div>
					</div>
					<div class="form-group">
	...
	<div id="userMan">
		...
		<div class="mainScreen col-md-10">
			<div class="searchCon row">
				<form id="searchForm" class="searchForm form-horizontal col-md-7">
					<div class = "control-group">
						<div class="searchForm form-group">
							<label for="textBoxUserNames" class="searchForm col-sm-6">User Name(s)</label>
							<label for="textBoxCustomerNames" class="searchForm col-sm-6">Customer Name(s)</label>
						</div>
						<div class="controls">
							<div class="searchForm form-group">
								<div class="col-sm-6">
							...
							<div class="searchForm form-group">
								<div class="searchForm col-sm-offset-10 col-sm-2">
			  ...
			  <div class="addUserButtonCon col-md-offset-1 col-md-2">
				<div>
			...
			<div class="row" style="">
				<div id="userTable" class="userTable col-md-12">
					...
					<div class="form-group">
						<label for="textBoxrights" class="editFormElement col-md-2 control-label">Rights</label>
							<div class="editFormElement col-md-10">
								<textarea rows="2" id="textBoxrights" class="editFormElement form-control" name="rights">
								</textarea>
							</div>
					</div>
					<div class="form-group">
