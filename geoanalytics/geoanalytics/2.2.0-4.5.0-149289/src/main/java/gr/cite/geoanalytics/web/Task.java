...
public class Task implements Callable<RequestResult> {
	...
	Task(String url, HttpServletRequest theRequest, HttpServletResponse theResponse) {
		taskUrl = url;
		taskRequest = theRequest;
		taskResponse = theResponse;
	}
	
	public RequestResult resultReportStatus(String aURL, HttpServletRequest request, HttpServletResponse response) throws MalformedURLException {
	...
	public RequestResult call() throws Exception {
		return resultReportStatus(taskUrl, taskRequest, taskResponse);
	}
