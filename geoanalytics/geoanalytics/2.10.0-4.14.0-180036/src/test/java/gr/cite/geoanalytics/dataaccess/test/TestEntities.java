...
//	}
	...
	public void test() throws Exception {
		EntityManagerFactory entityManagerFactory = Persistence
				.createEntityManagerFactory("gr.cite.geoanalytics");
...
//		shImpOne.setCreatorID(usOne.getId());
...
//		shImpOne.setShapeImport(UUID.fromString("00000000-0000-0000-0000-000000000001"));
		...
		s.setShapeClass(3);
//		s.setShapeImport(shImpOne.getId());
...
//		entityManager.persist(shImpOne);
		...
		String gosEndpoint = ""; //TODO: get a valid one from clustermanager
		
		UserManager um = new UserManager();
//		String vs = vb.forShape(s).createViewStatement().getViewStatement();
//		vb.execute(gosEndpoint);
//		System.out.println(vs);
		...
		for (Shape sh : (List<Shape>) result) {
			System.out.println("Shape (" + sh.getId() + ") code : " + sh.getCode() + " creationDate : " + sh.getCreationDate() +
					" extraData" + sh.getExtraData() + " geometry: " + sh.getGeography().toText() + " creator id: " + sh.getCreatorID().toString());
		}
