...
import gr.cite.gaap.datatransferobjects.TaxonomyNameTrasnfer;
...
public class AdminController {
	...
	@RequestMapping(value = "/admin/taxonomies/listTaxonomies", method = RequestMethod.POST, consumes="application/json")
	public @ResponseBody ServiceResponse listTaxonomies(@RequestBody TaxonomyTransfer tt, HttpServletRequest request) throws Exception {
		List<String> taxonomies = taxonomyMan.listTaxonomies(tt.isActive());
		return (taxonomies == null? new ServiceResponse(false, null, "No taxonomies retrieved!"): new ServiceResponse(true, taxonomies, "taxonomies succesfully fetched"));
	}
	
	@RequestMapping(value = "/admin/taxonomies/listTerms", method = RequestMethod.POST, consumes="application/json")
	public @ResponseBody ServiceResponse listTaxonomyTerms(@RequestBody TaxonomyNameTrasnfer tn, HttpServletRequest request) throws Exception {
		Taxonomy t = taxonomyMan.findTaxonomyByName(tn.getTaxonomyName(), false);
		if(t == null) return new ServiceResponse(false, null, "Taxonomy " + tn.getTaxonomyName() + " does not exist");
		List<String> terms = taxonomyMan.listTermsOfTaxonomy(t.getId().toString(), true);
		return (terms == null? new ServiceResponse(false, null, "Not terms retrieved"): new ServiceResponse(true, terms, "Terms succesfully retrieved"));
	}
	
	@RequestMapping(value = "/admin/taxonomies/retrieveTerms", method = RequestMethod.POST, consumes="application/json")
	public @ResponseBody List<TaxonomyTermMessenger> retrieveTaxonomyTerms(@RequestBody TaxonomyNameTrasnfer taxonomy, HttpServletRequest request) throws Exception {
		Taxonomy t = taxonomyMan.findTaxonomyByName(taxonomy.getTaxonomyName(), false);
		if(t == null) throw new Exception("Taxonomy " + taxonomy.getTaxonomyName() + " does not exist");
	...
	@RequestMapping(value = "/admin/taxonomies/search", method = RequestMethod.POST, consumes="application/json")
	public @ResponseBody ServiceResponse searchTaxonomies(@RequestBody TaxonomySearchSelection taxonomySearchSelection) throws Exception {
		try {
	...
	public @ResponseBody UpdateResponse addTaxonomy(@RequestBody TaxonomyMessenger t) throws Exception {
		try {
			Principal creator = securityContextAccessor.getPrincipal();
	...
	public @ResponseBody UpdateResponse updateTaxonomy(@RequestBody TaxonomyMessenger t) throws Exception {
		try {
			Principal creator = securityContextAccessor.getPrincipal();
	...
	@RequestMapping(value = "/admin/taxonomies/addTerm", method = RequestMethod.POST, consumes="application/json")
	public @ResponseBody UpdateResponse addTaxonomyTerm(@RequestBody TaxonomyTermMessenger t) throws Exception {
		try {
			Principal creator = securityContextAccessor.getPrincipal();
	...
	public @ResponseBody UpdateResponse updateTaxonomyTerm(@RequestBody TaxonomyTermMessenger t) throws Exception {
		try {
			Principal creator = securityContextAccessor.getPrincipal();
