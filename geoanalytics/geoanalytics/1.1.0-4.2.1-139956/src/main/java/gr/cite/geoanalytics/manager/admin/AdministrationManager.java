...
//		this.repository = dataRepository;
	...
	public Map<String, Object> getAllInfo() throws Exception {
		...
		info.put(EntryType.TaxonomyTermCount.toString(), getTaxonomyTermCount());
...
//	}
	...
	{
		return taxonomyDao.count();
	}
	
	@Transactional(readOnly = true)
	public long getTaxonomyTermCount() throws Exception
	{
		return taxonomyTermDao.count();
	}
