...
public class DataMonitor implements Serializable{
	...
	final static Logger log = LoggerFactory.getLogger(DataMonitor.class);
...
//	private DataMonitor() {}
	...
	private static void initializeClient(String zkConnStr) {
		try {
			...
			client = CuratorFrameworkFactory.newClient(DataMonitor.zkConnStr, new ExponentialBackoffRetry(1000, Integer.MAX_VALUE));
		    client.start();
