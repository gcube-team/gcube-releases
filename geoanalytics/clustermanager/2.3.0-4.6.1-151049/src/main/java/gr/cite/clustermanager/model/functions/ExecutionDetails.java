...
public class ExecutionDetails implements Serializable {
	...
	public ExecutionDetails(){
		this(UUID.randomUUID().toString(), null, null, System.currentTimeMillis(), null, null, null);
	}
	
	public ExecutionDetails(String id, String submissionOrigin, String tenantName, Long startTimestamp, String userID, String pluginID, String projectID) {
		this.id = id;
