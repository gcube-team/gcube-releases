...
//
//public class DTSClient_CreateFTRowset {
//
...
//		
//		String transformationProgramID = "$FtsRowset_Transformer";
...
//		//BrokerXSLT_FARM_dc_anylanguage_to_ftRowset_anylanguage
//		xsltParameter.setName("xslt");
//		System.out.println("Xslt is: "+xslt);
...
//		
//		Parameter[] tProgramUnboundParameters = {xsltParameter, indexTypeParameter};
