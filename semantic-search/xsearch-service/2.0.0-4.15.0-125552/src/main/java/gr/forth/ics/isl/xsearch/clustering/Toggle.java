...
public class Toggle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cluster = (String) request.getParameter("cluster");

        updateLog(request, query, cluster);

    }

    public void updateLog(HttpServletRequest request, String query, String cluster) {

        String ip = request.getRemoteAddr();
        String date = IOSLog.getCurrentDate();

        String line = "\n" + Resources.SYSTEMNAME + "\t" + date + "\t" + ip + "\t" + query + "\tTOGGLE " + cluster;
