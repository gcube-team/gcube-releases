 ...
 */
public class Servlet_GetInitialResults extends HttpServlet {
    ...
    public void updateLog(HttpServletRequest request, String query) {

            String ip = request.getRemoteAddr();
            String date = IOSLog.getCurrentDate();

            String line = "\n" + Resources.SYSTEMNAME + "\t" + date + "\t" + ip + "\t" + query + "\tRESET";
