 ...
 */
public class RemoveAcceptedCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ses.equals("y")) {
            ...
            System.out.println("# The category '"+category+"' was removed! New list of session-based accepted categories: " + acceptedCategories);
        } else {
            Resources.MINING_ACCEPTED_CATEGORIES.remove(category);
            System.out.println("# The category '"+category+"' was removed! New list of accepted categories: " + Resources.MINING_ACCEPTED_CATEGORIES);
        }
