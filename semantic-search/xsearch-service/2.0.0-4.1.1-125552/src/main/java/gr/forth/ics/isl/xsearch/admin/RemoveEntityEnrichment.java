...
public class RemoveEntityEnrichment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ses.equals("y")) {
            ...
            templateQueries.remove(category);
            session.setAttribute("templateQueries", templateQueries);
            
            System.out.println("# The entiry enrichment of the category '" + category + "' was (session-based) removed! Now you can offer LOD entity enrichment for the following list of categories: " + templateQueries.keySet());

        } else {
            Resources.SPARQL_ENDPOINTS.remove(category);
            Resources.SPARQL_TEMPLATES.remove(category);
            System.out.println("# The entiry enrichment of the category '" + category + "' was removed! Now you can offer LOD entity enrichment for the following list of categories: " + Resources.SPARQL_TEMPLATES.keySet());
