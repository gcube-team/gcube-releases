...
//				id=(String)engine.service.startOperation(file,file.getRemotePath(), engine.owner, engine.primaryBackend, engine.DEFAULT_CHUNK_OPTION, engine.getContext(), engine.isReplaceOption());
//			else{
...
//			try {
//				if(((file.getInputStream() != null) || (file.getOutputStream()!=null)) || ((file.getLocalPath() != null) || (file.getRemotePath() != null)))
//					id=(String)engine.service.startOperation(file,file.getRemotePath(), engine.owner, engine.primaryBackend, ServiceEngine.DEFAULT_CHUNK_OPTION, engine.getContext(), engine.isReplaceOption());
//				else{
//					logger.error("parameters incompatible ");
//				}
//
...
//				throw new RemoteBackendException(" Error in "+engine.currentOperation+" operation: "+t.getMessage(), t.getCause());
//			}
//			String id=getRemoteObject(getMyFile(),engine.primaryBackend,engine.volatileBackend).toString();
...
//				idReturned=(String)engine.service.startOperation(getMyFile(), id, engine.owner, engine.primaryBackend, ServiceEngine.DEFAULT_CHUNK_OPTION, "", engine.isReplaceOption());
//			else 
...
//			throw new RemoteBackendException(" Error in "+engine.currentOperation+" operation: "+t.getMessage(), t.getCause());
//		}
//		String idReturned=getRemoteObject(getMyFile(),engine.primaryBackend,engine.volatileBackend).toString();
