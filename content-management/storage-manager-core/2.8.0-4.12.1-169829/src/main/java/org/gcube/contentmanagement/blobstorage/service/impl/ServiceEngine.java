...
//		put(true);
	...
	public RemoteResourceSource copyFile() {
		return copyFile(TransportManager.DEFAULT_TRANSPORT_MANAGER, MyFile.DEFAULT_REPLACE_OPTION);
	}


	@Override
	public RemoteResourceSource copyFile(String backendType) {
		return copyFile(backendType, MyFile.DEFAULT_REPLACE_OPTION);
	}

	@Override
	public RemoteResourceSource copyFile(boolean replaceOption) {
		return copyFile(TransportManager.DEFAULT_TRANSPORT_MANAGER, replaceOption);
	}
	...
	public RemoteResource duplicateFile() {
		return duplicateFile(TransportManager.DEFAULT_TRANSPORT_MANAGER);
	}
	...
	public RemoteResourceSource softCopy() {
		return softCopy(TransportManager.DEFAULT_TRANSPORT_MANAGER, MyFile.DEFAULT_REPLACE_OPTION);
	}


	@Override
	public RemoteResourceSource softCopy(String backendType) {
		return softCopy(backendType, MyFile.DEFAULT_REPLACE_OPTION);
	}

	@Override
	public RemoteResourceSource softCopy(boolean replaceOption) {
		return softCopy(TransportManager.DEFAULT_TRANSPORT_MANAGER, replaceOption);
	}	
...
//	the shared scope is a private scope. 
	...
	public RemoteResourceBoolean exist(){
		return exist(TransportManager.DEFAULT_TRANSPORT_MANAGER);
	}
