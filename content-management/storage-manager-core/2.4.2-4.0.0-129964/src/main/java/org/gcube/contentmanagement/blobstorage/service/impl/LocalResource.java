...
public class LocalResource extends Resource{
	...
	public InputStream RFileAsInputStream(String path){
		...
		try {
			if(((file.getInputStream() != null) || (file.getOutputStream()!=null)) || ((file.getLocalPath() != null) || (file.getRemotePath() != null)))
				engine.service.startOperation(file,file.getRemotePath(), engine.owner, engine.server, ServiceEngine.DEFAULT_CHUNK_OPTION, engine.getContext(), engine.isReplaceOption());
			else{
	...
	public InputStream RFileAStream(String path){
		...
		try {
			if(((file.getInputStream() != null) || (file.getOutputStream()!=null)) || ((file.getLocalPath() != null) || (file.getRemotePath() != null)))
				engine.service.startOperation(file,file.getRemotePath(), engine.owner, engine.server, engine.DEFAULT_CHUNK_OPTION, engine.getContext(), engine.isReplaceOption());
			else{
				logger.error("parameters incompatible ");
			}
