...
// the key for unlocked	the file 
	 ...
	 */
	public MyFile(String author, String name, String pathClient){
	...
	public MyFile(String author, String name, String pathClient, String pathServer){
		this.setOwner(author);
		this.setName(name);
		this.setLocalPath(pathClient);
	...
	/**
	 * set the local direcotry where is the file 
	 * @param localDir
	 */
	...
	/**
	 * get the remote directory where the resource will be stored
