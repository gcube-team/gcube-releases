...
public class LocalResource extends Resource{
	...
	public InputStream RFileAsInputStream(String path){
		...
		return is;
/*end test. remove comment following lines*/		
...
//			return is;
//		}else {
//			//try to get the object from volatile backend
//			retrieveRemoteObject(engine.volatileBackend);
//			InputStream is= file.getInputStream();
//			file.setInputStream(null);
//			return is;
//		}
	...
	private void retrieveRemoteObject(String[] backend) {
		try {
			if(((file.getInputStream() != null) || (file.getOutputStream()!=null)) || ((file.getLocalPath() != null) || (file.getRemotePath() != null)))
				engine.service.startOperation(file,file.getRemotePath(), engine.owner, backend, ServiceEngine.DEFAULT_CHUNK_OPTION, engine.getContext(), engine.isReplaceOption());
			else{
