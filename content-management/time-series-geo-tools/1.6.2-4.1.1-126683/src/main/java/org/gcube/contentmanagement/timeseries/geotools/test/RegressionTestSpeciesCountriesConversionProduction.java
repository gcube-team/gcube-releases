...
public class RegressionTestSpeciesCountriesConversionProduction {
	...
	public static void main(String[] args) {
		...
		configuration.setAquamapsDatabase("jdbc:postgresql://node50.p.d4science.research-infrastructures.eu/essentialaquamaps");
