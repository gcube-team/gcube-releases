...
public class TestDataExtensionDates {
	...
	public static void main (String[] args) throws Exception{
		...
		Tuple<String> singlenewcolumn = new Tuple<String> ("date","timestamp without time zone");
		newColumns.add(singlenewcolumn);
		
		String tableKey = "gid";		
		String tableKeyType = "serial";	
		String firstDimension = "time";
		
		DataExtenderFunctionalities functionality = DataExtenderFunctionalities.vti_dates;
		
		extender.extendTable(tableName, newColumns, tableKey,tableKeyType, firstDimension,functionality);
	}
