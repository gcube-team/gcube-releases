...
public class AquamapsPublisherDBCleaner {
	...
	public static void main (String[] args) throws Exception{
		...
		EngineConfiguration tscfg = new EngineConfiguration();
		tscfg.setConfigPath("./cfg/");
		tscfg.setDatabaseUserName("gcube");
		tscfg.setDatabasePassword("d4science");
		tscfg.setDatabaseURL("jdbc:postgresql://node49.p.d4science.research-infrastructures.eu/apublisherdb");
		connectionsManager.initAquamapsConnection(tscfg);
