...
public class TestDataExtensionSST {
	...
	public static void main (String[] args) throws Exception{
		...
		Tuple<String> singlenewcolumn = new Tuple<String> ("sst","real");
		...
		DataExtenderFunctionalities functionality = DataExtenderFunctionalities.sst;
