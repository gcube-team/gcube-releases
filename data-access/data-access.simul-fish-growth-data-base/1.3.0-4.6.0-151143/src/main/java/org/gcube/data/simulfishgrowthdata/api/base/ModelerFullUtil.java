...
public class ModelerFullUtil extends BaseUtil {
	...
	public Modeler add(Session session, ModelerFull modelerFull) throws Exception {
		return new ModelerUtil().add(session, new Modeler(modelerFull));
	}
...
//	public GlobalModel getGlobalModel(final int kind, final Long id) throws Exception {
//		return getGlobalModel(null, kind, id);
//	}
//
//	public GlobalModel getGlobalModel(final Session session, final int kind, final Long id) throws Exception {
//		Long modelerId;
...
//		}
//		Modeler modeler = session == null ? new ModelerUtil().getModeler(modelerId)
