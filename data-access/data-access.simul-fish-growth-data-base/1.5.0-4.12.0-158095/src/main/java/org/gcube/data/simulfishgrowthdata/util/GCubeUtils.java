...
public class GCubeUtils {
	...
	static private final Map<String, String> prefilledDBCredentials = new HashMap<String, String>();

	synchronized static public Map<String, String> getCredentials(final String dbEndpoint, final String scope)
			throws Exception {
	...
	synchronized static public void prefillDBCredentials(final String host, final String dbname, final String dbuser,
			final String dbpassPlain) {
	...
	synchronized static public void prefillDBCredentials(Map<String, String> credentials) {
		prefilledDBCredentials.clear();
		prefilledDBCredentials.put("hibernate.connection.driver_class", credentials.get("hibernate.connection.driver_class"));
		prefilledDBCredentials.put("hibernate.dialect", dialect);
		prefilledDBCredentials.put("hibernate.connection.url", credentials.get("hibernate.connection.url"));
		prefilledDBCredentials.put("hibernate.connection.username", credentials.get("hibernate.connection.username"));
		prefilledDBCredentials.put("hibernate.connection.password", credentials.get("hibernate.connection.password"));
	}
