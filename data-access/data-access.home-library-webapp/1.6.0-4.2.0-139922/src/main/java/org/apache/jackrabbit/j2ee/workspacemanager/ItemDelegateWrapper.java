...
//				e.printStackTrace();
		...
		case PrimaryNodeType.NT_WORKSPACE_FILE:
			...
			setFileProperties(contentNode, item.getContent());
		...
		case PrimaryNodeType.NT_WORKSPACE_REPORT:
			...
			setFileProperties(contentNodeR, item.getContent());
		...
		case PrimaryNodeType.NT_WORKSPACE_REPORT_TEMPLATE:
			...
			setFileProperties(contentNodeRT, item.getContent());
	...
	private void setPropOnUrl(Node contentNode,	Map<NodeProperty, String> map) {
		try{
			setFileProperties(contentNode, map);
		}catch (Exception e) {
	 ...
	 * @throws RepositoryException
	 */
	private void setFileProperties(Node nodeContent, Map<NodeProperty, String> delegateContent) throws RepositoryException {
		logger.info("Content map: " + delegateContent.toString());
