package org.apache.jackrabbit.j2ee.workspacemanager.storage;
...
public class GCUBEStorage {
	...
	public GCUBEStorage(String portalLogin, String scope, String serviceName){

		logger.info("Calling GCUBEStorage from user: " + portalLogin);
	...
	public IClient getStorage() throws RemoteBackendException {
		if (storage==null)
			try{
				this.storage = new StorageClient("org.gcube.portlets.user", serviceName,
						portalLogin, AccessType.SHARED, scope, false).getClient();	
			} catch (Exception e) {
