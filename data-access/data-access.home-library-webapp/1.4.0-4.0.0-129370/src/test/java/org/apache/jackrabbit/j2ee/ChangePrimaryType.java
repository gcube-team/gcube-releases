		...
		try {
			...
			for (AccessPoint ap:resource.profile().accessPoints()) {
				...
				if (ap.name().equals("JCR")) {
					...
					Node node = session.getNode("/Home/valentina.marioli/Workspace/AAA/languages");
					node.setPrimaryType("nthl:workspaceSharedItem");
//					Node myNode = node.addNode("myNode", "nthl:workspaceItem");
////					myNode.setProperty(hl:lastAction, value)
