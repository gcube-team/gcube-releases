...
public class Move extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			try{
				srcAbsPath = URLDecoder.decode(request.getParameter(ServletParameter.SRC_ABS_PATH), "UTF-8");
				destAbsPath = URLDecoder.decode(request.getParameter(ServletParameter.DEST_ABS_PATH), "UTF-8");
