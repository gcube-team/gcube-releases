...
public class JCRWorkspaceItem{
	...
	public String getIds(Node node, String idSharedFolder, String idTrashFolder, String idHiddenFolder) throws InternalErrorException, RepositoryException {
	 ...
	 * @throws RepositoryException
	 */
	public String getIdTrashFolder(Node node) throws InternalErrorException, RepositoryException {
