...
public class CanDeleteChildren extends HttpServlet {

	private static Logger logger = LoggerFactory.getLogger(CanDeleteChildren.class);
	...
	protected void doGet(HttpServletRequest request,
		...
		try{
			...
			logger.info("CanDeleteChildren servlet - ABS path not set ");
		}
		...
		try {
			...
			try{
				...
				Boolean flag = accessManager.canDeleteChildren(absPath);
				logger.debug("Check if " + session.getUserID() + " can delete children of node " + absPath + "? " + flag);
