...
public class AphiaNameServiceBindingStub extends org.apache.axis.client.Stub implements aphia.v1_0.wordss.AphiaNameServicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(aphia.v1_0.wordss.AphiaRecord[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[1] = oper;
        ...
        oper.setReturnClass(aphia.v1_0.wordss.Classification.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[7] = oper;
        ...
        oper.setReturnClass(aphia.v1_0.wordss.Source[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[8] = oper;
    ...
    private static void _initOperationDesc2(){
        ...
        oper.setReturnClass(aphia.v1_0.wordss.Vernacular[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[10] = oper;
    ...
    public AphiaNameServiceBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            cls = aphia.v1_0.wordss.Source[].class;
            ...
            cachedSerQNames.add(qName);
            cls = aphia.v1_0.wordss.AphiaRecord[].class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(arraysf);
            cachedDeserFactories.add(arraydf);
            ...
            cachedSerQNames.add(qName);
            cls = aphia.v1_0.wordss.Vernacular.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = aphia.v1_0.wordss.Classification.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public aphia.v1_0.wordss.AphiaRecord[] getAphiaRecords(java.lang.String scientificname, boolean like, boolean fuzzy, boolean marine_only, int offset) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (aphia.v1_0.wordss.AphiaRecord[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (aphia.v1_0.wordss.AphiaRecord[]) org.apache.axis.utils.JavaUtils.convert(_resp, aphia.v1_0.wordss.AphiaRecord[].class);
            }
        }
    }
    ...
    public aphia.v1_0.wordss.Classification getAphiaClassificationByID(int aphiaID) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (aphia.v1_0.wordss.Classification) _resp;
            } catch (java.lang.Exception _exception) {
                return (aphia.v1_0.wordss.Classification) org.apache.axis.utils.JavaUtils.convert(_resp, aphia.v1_0.wordss.Classification.class);
            }
        }
    }
    ...
    public aphia.v1_0.wordss.Source[] getSourcesByAphiaID(int aphiaID) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (aphia.v1_0.wordss.Source[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (aphia.v1_0.wordss.Source[]) org.apache.axis.utils.JavaUtils.convert(_resp, aphia.v1_0.wordss.Source[].class);
            }
        }
    }
    ...
    public aphia.v1_0.wordss.Vernacular[] getAphiaVernacularsByID(int aphiaID) throws java.rmi.RemoteException {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (aphia.v1_0.wordss.Vernacular[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (aphia.v1_0.wordss.Vernacular[]) org.apache.axis.utils.JavaUtils.convert(_resp, aphia.v1_0.wordss.Vernacular[].class);
            }
        }
    }
