...
//		System.out.println(resources.size());
		...
		WordssPlugin.binding = (aphia.v1_0.wordss.AphiaNameServiceBindingStub)
				new aphia.v1_0.wordss.AphiaNameServiceLocator().getAphiaNameServicePort();
		
//		AphiaNameServiceLocator.AphiaNameServicePort_address = "http://www.marinespecies.org/deepsea/aphia.php?p=soap";
	}

	public void testAphiaNameServicePortWSDL() throws Exception {
		javax.xml.rpc.ServiceFactory serviceFactory = javax.xml.rpc.ServiceFactory.newInstance();
		java.net.URL url = new java.net.URL(new aphia.v1_0.wordss.AphiaNameServiceLocator().getAphiaNameServicePortAddress() + "&wsdl=1");
		javax.xml.rpc.Service service = serviceFactory.createService(url, new aphia.v1_0.wordss.AphiaNameServiceLocator().getServiceName());
		assertTrue(service != null);
	}

	public void test1AphiaNameServicePortGetAphiaID() throws Exception {
		aphia.v1_0.wordss.AphiaNameServiceBindingStub binding;
		try {
			binding = (aphia.v1_0.wordss.AphiaNameServiceBindingStub)
					new aphia.v1_0.wordss.AphiaNameServiceLocator().getAphiaNameServicePort();
		}
	...
	public void test2AphiaNameServicePortGetAphiaRecords() throws Exception {
		...
		// Test operation
		aphia.v1_0.wordss.AphiaRecord[] value = null;
	...
	public void test8AphiaNameServicePortGetAphiaClassificationByID() throws Exception {
		...
		// Test operation
		aphia.v1_0.wordss.Classification value = null;
	...
	public void test9AphiaNameServicePortGetSourcesByAphiaID() throws Exception {
		...
		// Test operation
		aphia.v1_0.wordss.Source[] value = null;
	...
	public void test11AphiaNameServicePortGetAphiaVernacularsByID() throws Exception {
		...
		// Test operation
		aphia.v1_0.wordss.Vernacular[] value = null;
